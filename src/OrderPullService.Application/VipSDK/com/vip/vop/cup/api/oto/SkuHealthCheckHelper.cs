...
namespace com.vip.vop.cup.api.oto{
	...
	public class SkuHealthCheckHelper : TBeanSerializer<SkuHealthCheck>
	{
		
		public static SkuHealthCheckHelper OBJ = new SkuHealthCheckHelper();
		
		public static SkuHealthCheckHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(SkuHealthCheck structs, Protocol iprot){
		...
		public void Write(SkuHealthCheck structs, Protocol oprot){
		...
		public void Validate(SkuHealthCheck bean){
