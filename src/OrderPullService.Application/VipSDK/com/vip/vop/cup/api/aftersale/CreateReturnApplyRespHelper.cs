...
namespace com.vip.vop.cup.api.aftersale{
	...
	public class CreateReturnApplyRespHelper : TBeanSerializer<CreateReturnApplyResp>
	{
		
		public static CreateReturnApplyRespHelper OBJ = new CreateReturnApplyRespHelper();
		
		public static CreateReturnApplyRespHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(CreateReturnApplyResp structs, Protocol iprot){
		...
		public void Write(CreateReturnApplyResp structs, Protocol oprot){
		...
		public void Validate(CreateReturnApplyResp bean){
