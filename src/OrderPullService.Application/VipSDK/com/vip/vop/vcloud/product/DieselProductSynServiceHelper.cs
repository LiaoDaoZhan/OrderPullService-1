...
namespace com.vip.vop.vcloud.product{
	...
	public class DieselProductSynServiceHelper {
		...
		public class DieselProductSynServiceClient : OspRestStub , DieselProductSynService  {
			...
			public void download(long partnerId_) {
				
				send_download(partnerId_);
				recv_download();
				
			}
			
			
			private void send_download(long partnerId_){
			...
			public void validateProductByConfig(long partnerId_) {
				
				send_validateProductByConfig(partnerId_);
				recv_validateProductByConfig();
				
			}
			
			
			private void send_validateProductByConfig(long partnerId_){
