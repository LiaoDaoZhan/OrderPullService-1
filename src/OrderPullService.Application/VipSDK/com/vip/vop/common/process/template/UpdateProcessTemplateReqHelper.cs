...
namespace com.vip.vop.common.process.template{
	...
	public class UpdateProcessTemplateReqHelper : TBeanSerializer<UpdateProcessTemplateReq>
	{
		
		public static UpdateProcessTemplateReqHelper OBJ = new UpdateProcessTemplateReqHelper();
		
		public static UpdateProcessTemplateReqHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(UpdateProcessTemplateReq structs, Protocol iprot){
		...
		public void Write(UpdateProcessTemplateReq structs, Protocol oprot){
		...
		public void Validate(UpdateProcessTemplateReq bean){
