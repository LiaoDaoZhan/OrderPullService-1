...
namespace com.vip.vop.logistics.carrier.service{
	...
	public class ReportProblemShippingResultHelper : TBeanSerializer<ReportProblemShippingResult>
	{
		
		public static ReportProblemShippingResultHelper OBJ = new ReportProblemShippingResultHelper();
		...
		public void Read(ReportProblemShippingResult structs, Protocol iprot){
		...
		public void Write(ReportProblemShippingResult structs, Protocol oprot){
		...
		public void Validate(ReportProblemShippingResult bean){
