...
namespace com.vip.vop.logistics.wo{
	...
	public class RecheckRelyContentHelper : TBeanSerializer<RecheckRelyContent>
	{
		
		public static RecheckRelyContentHelper OBJ = new RecheckRelyContentHelper();
		...
		public void Read(RecheckRelyContent structs, Protocol iprot){
		...
		public void Write(RecheckRelyContent structs, Protocol oprot){
		...
		public void Validate(RecheckRelyContent bean){
