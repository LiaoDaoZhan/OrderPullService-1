					...
					if ("packages".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								com.vip.vop.omni.logistics.Package elem1;
								
								elem1 = new com.vip.vop.omni.logistics.Package();
								com.vip.vop.omni.logistics.PackageHelper.getInstance().Read(elem1, iprot);
