					...
					if ("traceInfos".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								com.vip.vop.omni.logistics.TraceInfo elem0;
								
								elem0 = new com.vip.vop.omni.logistics.TraceInfo();
								com.vip.vop.omni.logistics.TraceInfoHelper.getInstance().Read(elem0, iprot);
