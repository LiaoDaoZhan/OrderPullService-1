...
namespace com.vip.top.deliveryorder.service{
	...
	public class TmsOrderUnionModelHelper : TBeanSerializer<TmsOrderUnionModel>
	{
		
		public static TmsOrderUnionModelHelper OBJ = new TmsOrderUnionModelHelper();
		...
		public void Read(TmsOrderUnionModel structs, Protocol iprot){
			...
			if(schemeStruct != null){
				...
				while(true){
					...
					if ("tempCustCode".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetTempCustCode(value);
					}
					...
					if ("carrierPointCustCode".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetCarrierPointCustCode(value);
					}
					...
					if ("officeName".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetOfficeName(value);
					}
					...
					if ("officeOutName".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetOfficeOutName(value);
					}
					...
					if ("officeCode".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetOfficeCode(value);
					}
					...
					if ("countryCode".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetCountryCode(value);
					}
		...
		public void Write(TmsOrderUnionModel structs, Protocol oprot){
			...
			if(structs.GetTempCustCode() != null) {
				
				oprot.WriteFieldBegin("tempCustCode");
				oprot.WriteString(structs.GetTempCustCode());
			...
			if(structs.GetIsSecondMatchAppraise() != null) {
				...
				oprot.WriteBool((bool)structs.GetIsSecondMatchAppraise());
			...
			if(structs.GetCarrierPointCustCode() != null) {
				
				oprot.WriteFieldBegin("carrierPointCustCode");
				oprot.WriteString(structs.GetCarrierPointCustCode());
				
				oprot.WriteFieldEnd();
			}
			
			
			if(structs.GetOfficeName() != null) {
				
				oprot.WriteFieldBegin("officeName");
				oprot.WriteString(structs.GetOfficeName());
				
				oprot.WriteFieldEnd();
			}
			
			
			if(structs.GetOfficeOutName() != null) {
				
				oprot.WriteFieldBegin("officeOutName");
				oprot.WriteString(structs.GetOfficeOutName());
			...
			if(structs.GetOfficeCode() != null) {
				
				oprot.WriteFieldBegin("officeCode");
				oprot.WriteString(structs.GetOfficeCode());
			...
			if(structs.GetCountryCode() != null) {
				
				oprot.WriteFieldBegin("countryCode");
				oprot.WriteString(structs.GetCountryCode());
		...
		public void Validate(TmsOrderUnionModel bean){
