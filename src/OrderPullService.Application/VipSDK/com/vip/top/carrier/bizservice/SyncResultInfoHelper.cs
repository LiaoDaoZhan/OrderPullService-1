...
namespace com.vip.top.carrier.bizservice{
	...
	public class SyncResultInfoHelper : TBeanSerializer<SyncResultInfo>
	{
		
		public static SyncResultInfoHelper OBJ = new SyncResultInfoHelper();
		...
		public void Read(SyncResultInfo structs, Protocol iprot){
		...
		public void Write(SyncResultInfo structs, Protocol oprot){
		...
		public void Validate(SyncResultInfo bean){
