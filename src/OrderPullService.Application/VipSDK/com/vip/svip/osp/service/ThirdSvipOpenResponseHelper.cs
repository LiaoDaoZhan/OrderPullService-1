...
namespace com.vip.svip.osp.service{
	...
	public class ThirdSvipOpenResponseHelper : TBeanSerializer<ThirdSvipOpenResponse>
	{
		
		public static ThirdSvipOpenResponseHelper OBJ = new ThirdSvipOpenResponseHelper();
		
		public static ThirdSvipOpenResponseHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(ThirdSvipOpenResponse structs, Protocol iprot){
		...
		public void Write(ThirdSvipOpenResponse structs, Protocol oprot){
		...
		public void Validate(ThirdSvipOpenResponse bean){
