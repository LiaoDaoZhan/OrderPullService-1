...
namespace com.vip.svip.osp.service{
	...
	public class GetOpGoodsIdRequestHelper : TBeanSerializer<GetOpGoodsIdRequest>
	{
		
		public static GetOpGoodsIdRequestHelper OBJ = new GetOpGoodsIdRequestHelper();
		...
		public void Read(GetOpGoodsIdRequest structs, Protocol iprot){
			...
			if(schemeStruct != null){
				...
				while(true){
					...
					if ("condCode".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetCondCode(value);
					}
		...
		public void Write(GetOpGoodsIdRequest structs, Protocol oprot){
			...
			if(structs.GetCondCode() != null) {
				
				oprot.WriteFieldBegin("condCode");
				oprot.WriteString(structs.GetCondCode());
		...
		public void Validate(GetOpGoodsIdRequest bean){
