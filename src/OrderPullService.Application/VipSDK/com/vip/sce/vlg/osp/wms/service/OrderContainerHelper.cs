...
namespace com.vip.sce.vlg.osp.wms.service{
	...
	public class OrderContainerHelper : TBeanSerializer<OrderContainer>
	{
		
		public static OrderContainerHelper OBJ = new OrderContainerHelper();
		...
		public void Read(OrderContainer structs, Protocol iprot){
			...
			if(schemeStruct != null){
				...
				while(true){
					...
					if ("order_detail".Equals(schemeField.Trim())){
						...
						needSkip = false;
						List<com.vip.sce.vlg.osp.wms.service.OrderContainerDetail> value;
						
						value = new List<com.vip.sce.vlg.osp.wms.service.OrderContainerDetail>();
						iprot.ReadListBegin();
						while(true){
							
							try{
								
								com.vip.sce.vlg.osp.wms.service.OrderContainerDetail elem0;
								
								elem0 = new com.vip.sce.vlg.osp.wms.service.OrderContainerDetail();
								com.vip.sce.vlg.osp.wms.service.OrderContainerDetailHelper.getInstance().Read(elem0, iprot);
		...
		public void Write(OrderContainer structs, Protocol oprot){
			...
			if(structs.GetOut_type() != null) {
				...
				throw new ArgumentException("out_type can not be null!");
			}
			...
			if(structs.GetOrder_detail() != null) {
				...
				foreach(com.vip.sce.vlg.osp.wms.service.OrderContainerDetail _item0 in structs.GetOrder_detail()){
					
					
					com.vip.sce.vlg.osp.wms.service.OrderContainerDetailHelper.getInstance().Write(_item0, oprot);
		...
		public void Validate(OrderContainer bean){
