					...
					if ("returnList".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								com.vip.sce.vlg.osp.wms.service.OutWmsReturnOrderHeader elem1;
								
								elem1 = new com.vip.sce.vlg.osp.wms.service.OutWmsReturnOrderHeader();
								com.vip.sce.vlg.osp.wms.service.OutWmsReturnOrderHeaderHelper.getInstance().Read(elem1, iprot);
