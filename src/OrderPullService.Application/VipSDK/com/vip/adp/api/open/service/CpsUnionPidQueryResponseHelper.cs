...
namespace com.vip.adp.api.open.service{
	...
	public class CpsUnionPidQueryResponseHelper : TBeanSerializer<CpsUnionPidQueryResponse>
	{
		
		public static CpsUnionPidQueryResponseHelper OBJ = new CpsUnionPidQueryResponseHelper();
		
		public static CpsUnionPidQueryResponseHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(CpsUnionPidQueryResponse structs, Protocol iprot){
		...
		public void Write(CpsUnionPidQueryResponse structs, Protocol oprot){
		...
		public void Validate(CpsUnionPidQueryResponse bean){
