...
namespace com.vip.api.promotion.vis.protcontract.service{
	...
	public class ProtContractDiscountInfoParamsHelper : TBeanSerializer<ProtContractDiscountInfoParams>
	{
		
		public static ProtContractDiscountInfoParamsHelper OBJ = new ProtContractDiscountInfoParamsHelper();
		...
		public void Read(ProtContractDiscountInfoParams structs, Protocol iprot){
					...
					if ("buyAndCutInfos".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								com.vip.api.promotion.vis.protcontract.service.BuyAndCutInfo elem2;
								
								elem2 = new com.vip.api.promotion.vis.protcontract.service.BuyAndCutInfo();
								com.vip.api.promotion.vis.protcontract.service.BuyAndCutInfoHelper.getInstance().Read(elem2, iprot);
		...
		public void Write(ProtContractDiscountInfoParams structs, Protocol oprot){
		...
		public void Validate(ProtContractDiscountInfoParams bean){
