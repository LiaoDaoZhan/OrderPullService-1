...
namespace com.vip.api.promotion.vis.protcontract.service{
	...
	public class ProtContractDiscountInfoModel {
		...
		private string exclusivePriceDiscount_;
		...
		public string GetExclusivePriceDiscount(){
			return this.exclusivePriceDiscount_;
		}
		
		public void SetExclusivePriceDiscount(string value){
			this.exclusivePriceDiscount_ = value;
		}
