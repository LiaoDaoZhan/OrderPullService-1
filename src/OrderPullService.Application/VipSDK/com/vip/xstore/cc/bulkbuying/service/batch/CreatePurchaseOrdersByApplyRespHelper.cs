...
namespace com.vip.xstore.cc.bulkbuying.service.batch{
	...
	public class CreatePurchaseOrdersByApplyRespHelper : TBeanSerializer<CreatePurchaseOrdersByApplyResp>
	{
		
		public static CreatePurchaseOrdersByApplyRespHelper OBJ = new CreatePurchaseOrdersByApplyRespHelper();
		...
		public void Read(CreatePurchaseOrdersByApplyResp structs, Protocol iprot){
		...
		public void Write(CreatePurchaseOrdersByApplyResp structs, Protocol oprot){
		...
		public void Validate(CreatePurchaseOrdersByApplyResp bean){
