...
namespace com.vip.xstore.cc.bulkbuying.service.batch{
	...
	public class CreatePurchaseOrdersByApplyReqHelper : TBeanSerializer<CreatePurchaseOrdersByApplyReq>
	{
		
		public static CreatePurchaseOrdersByApplyReqHelper OBJ = new CreatePurchaseOrdersByApplyReqHelper();
		...
		public void Read(CreatePurchaseOrdersByApplyReq structs, Protocol iprot){
		...
		public void Write(CreatePurchaseOrdersByApplyReq structs, Protocol oprot){
		...
		public void Validate(CreatePurchaseOrdersByApplyReq bean){
