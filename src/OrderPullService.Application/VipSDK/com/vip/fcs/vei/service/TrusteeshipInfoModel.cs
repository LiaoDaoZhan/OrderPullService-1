...
namespace com.vip.fcs.vei.service{
	...
	public class TrusteeshipInfoModel {
		...
		///<summary>
		/// 确认状态（MP商家确认签约信息，第一期先程序默认设置为“已确认”），0为未确认，1为已确认
		///</summary>
		
		private byte? confirmStatus_;
		...
		///<summary>
		/// 托管是否有效。此字段需要“托管（签约）状态”、“服务开始时间”、“服务结束时间”和“确认状态”4个都有效时才返回true
		///</summary>
		...
		public void SetConfirmStatus(byte? value){
			this.confirmStatus_ = value;
		}
