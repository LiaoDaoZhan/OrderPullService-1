...
namespace com.vip.fcs.ap.service{
	...
	public class VendorBillDiscountDetailHelper : TBeanSerializer<VendorBillDiscountDetail>
	{
		
		public static VendorBillDiscountDetailHelper OBJ = new VendorBillDiscountDetailHelper();
		...
		public void Read(VendorBillDiscountDetail structs, Protocol iprot){
			...
			if(schemeStruct != null){
				...
				while(true){
					...
					if ("isNewFlow".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetIsNewFlow(value);
					}
					...
					if ("dataStage".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetDataStage(value);
					}
		...
		public void Write(VendorBillDiscountDetail structs, Protocol oprot){
			...
			if(structs.GetIsNewFlow() != null) {
				
				oprot.WriteFieldBegin("isNewFlow");
				oprot.WriteString(structs.GetIsNewFlow());
			...
			if(structs.GetDataStage() != null) {
				
				oprot.WriteFieldBegin("dataStage");
				oprot.WriteString(structs.GetDataStage());
		...
		public void Validate(VendorBillDiscountDetail bean){
