...
namespace com.vip.fcs.ap.service{
	...
	public class VendorBillGoodsDetailHelper : TBeanSerializer<VendorBillGoodsDetail>
	{
		
		public static VendorBillGoodsDetailHelper OBJ = new VendorBillGoodsDetailHelper();
		...
		public void Read(VendorBillGoodsDetail structs, Protocol iprot){
			...
			if(schemeStruct != null){
				...
				while(true){
					...
					if ("billStatus".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetBillStatus(value);
					}
					...
					if ("brandAdmin".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetBrandAdmin(value);
					}
					...
					if ("detailLineName".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetDetailLineName(value);
					}
					...
					if ("specialReturnFlag".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetSpecialReturnFlag(value);
					}
					...
					if ("sourceStatus".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetSourceStatus(value);
					}
					...
					if ("specialReturnDupFlag".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetSpecialReturnDupFlag(value);
					}
					...
					if ("vendorReturnNo".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetVendorReturnNo(value);
					}
					...
					if ("specialDate".Equals(schemeField.Trim())){
						
						needSkip = false;
						System.DateTime? value;
						value = Osp.Sdk.Util.TimeUtil.FromUnixTime(iprot.ReadI64()); 
						
						structs.SetSpecialDate(value);
					}
					...
					if ("giftFlag".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetGiftFlag(value);
					}
					...
					if ("htBatchNo".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetHtBatchNo(value);
					}
					...
					if ("nlcTotalAmount".Equals(schemeField.Trim())){
						
						needSkip = false;
						double? value;
						value = iprot.ReadDouble();
						
						structs.SetNlcTotalAmount(value);
					}
					...
					if ("returnVarianceDocNo".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetReturnVarianceDocNo(value);
					}
					...
					if ("vin".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetVin(value);
					}
					...
					if ("returnVariancePoNo".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetReturnVariancePoNo(value);
					}
					...
					if ("headerId".Equals(schemeField.Trim())){
						
						needSkip = false;
						long? value;
						value = iprot.ReadI64(); 
						
						structs.SetHeaderId(value);
					}
					...
					if ("lineId".Equals(schemeField.Trim())){
						
						needSkip = false;
						long? value;
						value = iprot.ReadI64(); 
						
						structs.SetLineId(value);
					}
					...
					if ("stagePercent".Equals(schemeField.Trim())){
						
						needSkip = false;
						double? value;
						value = iprot.ReadDouble();
						
						structs.SetStagePercent(value);
					}
		...
		public void Write(VendorBillGoodsDetail structs, Protocol oprot){
			...
			if(structs.GetBillStatus() != null) {
				
				oprot.WriteFieldBegin("billStatus");
				oprot.WriteString(structs.GetBillStatus());
			...
			if(structs.GetBrandAdmin() != null) {
				
				oprot.WriteFieldBegin("brandAdmin");
				oprot.WriteString(structs.GetBrandAdmin());
			...
			if(structs.GetDetailLineName() != null) {
				
				oprot.WriteFieldBegin("detailLineName");
				oprot.WriteString(structs.GetDetailLineName());
			...
			if(structs.GetSpecialReturnFlag() != null) {
				
				oprot.WriteFieldBegin("specialReturnFlag");
				oprot.WriteString(structs.GetSpecialReturnFlag());
				
				oprot.WriteFieldEnd();
			}
			
			
			if(structs.GetSourceStatus() != null) {
				
				oprot.WriteFieldBegin("sourceStatus");
				oprot.WriteString(structs.GetSourceStatus());
				
				oprot.WriteFieldEnd();
			}
			
			
			if(structs.GetSpecialReturnDupFlag() != null) {
				
				oprot.WriteFieldBegin("specialReturnDupFlag");
				oprot.WriteString(structs.GetSpecialReturnDupFlag());
				
				oprot.WriteFieldEnd();
			}
			
			
			if(structs.GetVendorReturnNo() != null) {
				
				oprot.WriteFieldBegin("vendorReturnNo");
				oprot.WriteString(structs.GetVendorReturnNo());
				
				oprot.WriteFieldEnd();
			}
			
			
			if(structs.GetSpecialDate() != null) {
				
				oprot.WriteFieldBegin("specialDate");
				oprot.WriteI64(Osp.Sdk.Util.TimeUtil.ToUnixTime((System.DateTime)structs.GetSpecialDate())); 
				
				oprot.WriteFieldEnd();
			}
			
			
			if(structs.GetGiftFlag() != null) {
				
				oprot.WriteFieldBegin("giftFlag");
				oprot.WriteString(structs.GetGiftFlag());
				
				oprot.WriteFieldEnd();
			}
			
			
			if(structs.GetHtBatchNo() != null) {
				
				oprot.WriteFieldBegin("htBatchNo");
				oprot.WriteString(structs.GetHtBatchNo());
				
				oprot.WriteFieldEnd();
			}
			
			
			if(structs.GetNlcTotalAmount() != null) {
				
				oprot.WriteFieldBegin("nlcTotalAmount");
				oprot.WriteDouble((double)structs.GetNlcTotalAmount());
				
				oprot.WriteFieldEnd();
			}
			
			
			if(structs.GetReturnVarianceDocNo() != null) {
				
				oprot.WriteFieldBegin("returnVarianceDocNo");
				oprot.WriteString(structs.GetReturnVarianceDocNo());
				
				oprot.WriteFieldEnd();
			}
			
			
			if(structs.GetVin() != null) {
				
				oprot.WriteFieldBegin("vin");
				oprot.WriteString(structs.GetVin());
				
				oprot.WriteFieldEnd();
			}
			
			
			if(structs.GetReturnVariancePoNo() != null) {
				
				oprot.WriteFieldBegin("returnVariancePoNo");
				oprot.WriteString(structs.GetReturnVariancePoNo());
				
				oprot.WriteFieldEnd();
			}
			
			
			if(structs.GetHeaderId() != null) {
				
				oprot.WriteFieldBegin("headerId");
				oprot.WriteI64((long)structs.GetHeaderId()); 
				
				oprot.WriteFieldEnd();
			}
			
			
			if(structs.GetLineId() != null) {
				
				oprot.WriteFieldBegin("lineId");
				oprot.WriteI64((long)structs.GetLineId()); 
				
				oprot.WriteFieldEnd();
			}
			
			
			if(structs.GetStagePercent() != null) {
				
				oprot.WriteFieldBegin("stagePercent");
				oprot.WriteDouble((double)structs.GetStagePercent());
		...
		public void Validate(VendorBillGoodsDetail bean){
