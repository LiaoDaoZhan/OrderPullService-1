...
namespace com.vip.fcs.ap.service{
	...
	public class VendorDiscountDetailRespItemHelper : TBeanSerializer<VendorDiscountDetailRespItem>
	{
		
		public static VendorDiscountDetailRespItemHelper OBJ = new VendorDiscountDetailRespItemHelper();
		
		public static VendorDiscountDetailRespItemHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(VendorDiscountDetailRespItem structs, Protocol iprot){
			...
			if(schemeStruct != null){
				...
				while(true){
					...
					if ("billDetails".Equals(schemeField.Trim())){
						...
						needSkip = false;
						List<com.vip.fcs.ap.service.VendorBillDiscountDetail> value;
						
						value = new List<com.vip.fcs.ap.service.VendorBillDiscountDetail>();
						iprot.ReadListBegin();
						while(true){
							
							try{
								
								com.vip.fcs.ap.service.VendorBillDiscountDetail elem2;
								
								elem2 = new com.vip.fcs.ap.service.VendorBillDiscountDetail();
								com.vip.fcs.ap.service.VendorBillDiscountDetailHelper.getInstance().Read(elem2, iprot);
		...
		public void Write(VendorDiscountDetailRespItem structs, Protocol oprot){
			...
			if(structs.GetBillDetails() != null) {
				...
				foreach(com.vip.fcs.ap.service.VendorBillDiscountDetail _item0 in structs.GetBillDetails()){
					
					
					com.vip.fcs.ap.service.VendorBillDiscountDetailHelper.getInstance().Write(_item0, oprot);
		...
		public void Validate(VendorDiscountDetailRespItem bean){
