...
namespace com.vip.fcs.ap.service{
	...
	public class VendorBillGoodsDetail {
		...
		///<summary>
		/// 来源表标识，对应T-1数据的唯一性globalId
		///</summary>
		
		private string brandAdmin_;
		...
		private string specialReturnFlag_;
		
		///<summary>
		/// NEW-新建：刚抽数还未出账单； PROCESSING-预处理中：部分预处理 PROCESSED-预处理完成
		///</summary>
		
		private string sourceStatus_;
		
		///<summary>
		/// 常态账单，客退重复带进带进账单标识，Y为重复带进账单
		///</summary>
		
		private string specialReturnDupFlag_;
		
		///<summary>
		/// 退供单号
		///</summary>
		
		private string vendorReturnNo_;
		
		///<summary>
		/// 退供日期
		///</summary>
		
		private System.DateTime? specialDate_;
		
		///<summary>
		/// 赠品标记
		///</summary>
		
		private string giftFlag_;
		
		///<summary>
		/// 海淘揽收批次
		///</summary>
		
		private string htBatchNo_;
		
		///<summary>
		/// 抽检总金额，原attribute18
		///</summary>
		
		private double? nlcTotalAmount_;
		
		///<summary>
		/// 退供差异单号
		///</summary>
		
		private string returnVarianceDocNo_;
		...
		private string returnVariancePoNo_;
		...
		public string GetBrandAdmin(){
			return this.brandAdmin_;
		}
		
		public void SetBrandAdmin(string value){
			this.brandAdmin_ = value;
		}
		...
		public string GetSpecialReturnFlag(){
			return this.specialReturnFlag_;
		}
		
		public void SetSpecialReturnFlag(string value){
			this.specialReturnFlag_ = value;
		}
		...
		public void SetSourceStatus(string value){
			this.sourceStatus_ = value;
		}
		public string GetSpecialReturnDupFlag(){
			return this.specialReturnDupFlag_;
		}
		
		public void SetSpecialReturnDupFlag(string value){
			this.specialReturnDupFlag_ = value;
		}
		public string GetVendorReturnNo(){
			return this.vendorReturnNo_;
		}
		
		public void SetVendorReturnNo(string value){
			this.vendorReturnNo_ = value;
		}
		public System.DateTime? GetSpecialDate(){
			return this.specialDate_;
		}
		
		public void SetSpecialDate(System.DateTime? value){
			this.specialDate_ = value;
		}
		...
		public void SetGiftFlag(string value){
			this.giftFlag_ = value;
		}
		public string GetHtBatchNo(){
			return this.htBatchNo_;
		}
		
		public void SetHtBatchNo(string value){
			this.htBatchNo_ = value;
		}
		public double? GetNlcTotalAmount(){
			return this.nlcTotalAmount_;
		}
		
		public void SetNlcTotalAmount(double? value){
			this.nlcTotalAmount_ = value;
		}
		public string GetReturnVarianceDocNo(){
			return this.returnVarianceDocNo_;
		}
		
		public void SetReturnVarianceDocNo(string value){
			this.returnVarianceDocNo_ = value;
		}
		...
		public string GetReturnVariancePoNo(){
			return this.returnVariancePoNo_;
		}
		
		public void SetReturnVariancePoNo(string value){
			this.returnVariancePoNo_ = value;
		}
