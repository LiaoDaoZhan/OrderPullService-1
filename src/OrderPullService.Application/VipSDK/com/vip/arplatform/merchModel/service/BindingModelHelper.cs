...
namespace com.vip.arplatform.merchModel.service{
	...
	public class BindingModelHelper : TBeanSerializer<BindingModel>
	{
		
		public static BindingModelHelper OBJ = new BindingModelHelper();
		...
		public void Read(BindingModel structs, Protocol iprot){
		...
		public void Write(BindingModel structs, Protocol oprot){
		...
		public void Validate(BindingModel bean){
