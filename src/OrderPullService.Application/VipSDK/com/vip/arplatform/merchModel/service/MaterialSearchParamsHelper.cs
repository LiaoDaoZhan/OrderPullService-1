...
namespace com.vip.arplatform.merchModel.service{
	...
	public class MaterialSearchParamsHelper : TBeanSerializer<MaterialSearchParams>
	{
		
		public static MaterialSearchParamsHelper OBJ = new MaterialSearchParamsHelper();
		...
		public void Read(MaterialSearchParams structs, Protocol iprot){
		...
		public void Write(MaterialSearchParams structs, Protocol oprot){
		...
		public void Validate(MaterialSearchParams bean){
