...
namespace com.vip.vipapis.productsale.service{
	...
	public class ProductSaleInfoModelHelper : TBeanSerializer<ProductSaleInfoModel>
	{
		
		public static ProductSaleInfoModelHelper OBJ = new ProductSaleInfoModelHelper();
		...
		public void Read(ProductSaleInfoModel structs, Protocol iprot){
		...
		public void Write(ProductSaleInfoModel structs, Protocol oprot){
		...
		public void Validate(ProductSaleInfoModel bean){
