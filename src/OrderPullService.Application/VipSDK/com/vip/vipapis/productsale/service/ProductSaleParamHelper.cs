...
namespace com.vip.vipapis.productsale.service{
	...
	public class ProductSaleParamHelper : TBeanSerializer<ProductSaleParam>
	{
		
		public static ProductSaleParamHelper OBJ = new ProductSaleParamHelper();
		...
		public void Read(ProductSaleParam structs, Protocol iprot){
		...
		public void Write(ProductSaleParam structs, Protocol oprot){
		...
		public void Validate(ProductSaleParam bean){
