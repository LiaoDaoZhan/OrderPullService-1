...
namespace vip.vop.omni.inventory{
	...
	public class OmniInventoryServiceHelper {
		...
		public class updateStoreInventory4Inner_args {
		...
		public class updateStoreInventory4Inner_result {
		...
		public class updateStoreInventory4Inner_argsHelper : TBeanSerializer<updateStoreInventory4Inner_args>
		{
			
			public static updateStoreInventory4Inner_argsHelper OBJ = new updateStoreInventory4Inner_argsHelper();
			
			public static updateStoreInventory4Inner_argsHelper getInstance() {
				
				return OBJ;
			}
			
			
			public void Read(updateStoreInventory4Inner_args structs, Protocol iprot){
			...
			public void Write(updateStoreInventory4Inner_args structs, Protocol oprot){
			...
			public void Validate(updateStoreInventory4Inner_args bean){
		...
		public class updateStoreInventory4Inner_resultHelper : TBeanSerializer<updateStoreInventory4Inner_result>
		{
			
			public static updateStoreInventory4Inner_resultHelper OBJ = new updateStoreInventory4Inner_resultHelper();
			
			public static updateStoreInventory4Inner_resultHelper getInstance() {
				
				return OBJ;
			}
			
			
			public void Read(updateStoreInventory4Inner_result structs, Protocol iprot){
			...
			public void Write(updateStoreInventory4Inner_result structs, Protocol oprot){
			...
			public void Validate(updateStoreInventory4Inner_result bean){
		...
		public class OmniInventoryServiceClient : OspRestStub , OmniInventoryService  {
			...
			public void updateStoreInventory4Inner(com.vip.vop.omni.inventory.InventoryUpdateRequest request_) {
				
				send_updateStoreInventory4Inner(request_);
				recv_updateStoreInventory4Inner();
				
			}
			
			
			private void send_updateStoreInventory4Inner(com.vip.vop.omni.inventory.InventoryUpdateRequest request_){
				
				InitInvocation("updateStoreInventory4Inner");
				
				updateStoreInventory4Inner_args args = new updateStoreInventory4Inner_args();
				args.SetRequest(request_);
				
				SendBase(args, updateStoreInventory4Inner_argsHelper.getInstance());
			}
			
			
			private void recv_updateStoreInventory4Inner(){
				
				updateStoreInventory4Inner_result result = new updateStoreInventory4Inner_result();
				ReceiveBase(result, updateStoreInventory4Inner_resultHelper.getInstance());
