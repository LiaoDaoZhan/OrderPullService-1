					...
					if ("children".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.category.Category elem2;
								
								elem2 = new vipapis.category.Category();
								vipapis.category.CategoryHelper.getInstance().Read(elem2, iprot);
					...
					if ("mapping".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.category.CategoryMapping elem4;
								
								elem4 = new vipapis.category.CategoryMapping();
								vipapis.category.CategoryMappingHelper.getInstance().Read(elem4, iprot);
					...
					if ("attributes".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.category.Attribute elem7;
								
								elem7 = new vipapis.category.Attribute();
								vipapis.category.AttributeHelper.getInstance().Read(elem7, iprot);
