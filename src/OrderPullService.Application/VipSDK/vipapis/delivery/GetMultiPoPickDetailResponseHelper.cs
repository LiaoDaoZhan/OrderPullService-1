					...
					if ("pick_detail_list".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.delivery.MultiPickDetailInfo elem0;
								
								elem0 = new vipapis.delivery.MultiPickDetailInfo();
								vipapis.delivery.MultiPickDetailInfoHelper.getInstance().Read(elem0, iprot);
