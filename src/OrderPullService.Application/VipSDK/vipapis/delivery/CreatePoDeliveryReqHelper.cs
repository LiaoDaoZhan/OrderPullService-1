...
namespace vipapis.delivery{
	...
	public class CreatePoDeliveryReqHelper : TBeanSerializer<CreatePoDeliveryReq>
	{
		
		public static CreatePoDeliveryReqHelper OBJ = new CreatePoDeliveryReqHelper();
		...
		public void Read(CreatePoDeliveryReq structs, Protocol iprot){
			...
			if(schemeStruct != null){
				...
				while(true){
					...
					if ("po_nos".Equals(schemeField.Trim())){
		...
		public void Write(CreatePoDeliveryReq structs, Protocol oprot){
			...
			if(structs.GetPo_nos() != null) {
				
				oprot.WriteFieldBegin("po_nos");
				
				oprot.WriteListBegin();
				foreach(string _item0 in structs.GetPo_nos()){
				...
				throw new ArgumentException("po_nos can not be null!");
			}
		...
		public void Validate(CreatePoDeliveryReq bean){
