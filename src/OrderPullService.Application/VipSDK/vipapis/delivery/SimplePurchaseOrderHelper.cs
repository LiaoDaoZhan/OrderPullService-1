...
namespace vipapis.delivery{
	...
	public class SimplePurchaseOrderHelper : TBeanSerializer<SimplePurchaseOrder>
	{
		
		public static SimplePurchaseOrderHelper OBJ = new SimplePurchaseOrderHelper();
		...
		public void Read(SimplePurchaseOrder structs, Protocol iprot){
		...
		public void Write(SimplePurchaseOrder structs, Protocol oprot){
		...
		public void Validate(SimplePurchaseOrder bean){
