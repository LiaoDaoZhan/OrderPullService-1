	...
	public class OrderDetailHelper : TBeanSerializer<OrderDetail>
	{
					...
					if ("promotions".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.delivery.PromotionInfo elem0;
								
								elem0 = new vipapis.delivery.PromotionInfo();
								vipapis.delivery.PromotionInfoHelper.getInstance().Read(elem0, iprot);
					...
					if ("failed_promotions".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.delivery.FailedPromotionInfo elem2;
								
								elem2 = new vipapis.delivery.FailedPromotionInfo();
								vipapis.delivery.FailedPromotionInfoHelper.getInstance().Read(elem2, iprot);
		...
		public void Write(OrderDetail structs, Protocol oprot){
			...
			if(structs.GetActual_market_price() != null) {
				...
				oprot.WriteDouble((double)structs.GetActual_market_price());
