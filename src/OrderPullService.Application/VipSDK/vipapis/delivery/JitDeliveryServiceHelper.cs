...
namespace vipapis.delivery{
	...
	public class JitDeliveryServiceHelper {
		...
		public class cancelDelivery_args {
			
			///<summary>
			/// 取消送货单请求
			///</summary>
			
			private vipapis.delivery.CancelDeliveryReq cancelDeliveryReq_;
			
			public vipapis.delivery.CancelDeliveryReq GetCancelDeliveryReq(){
				return this.cancelDeliveryReq_;
			}
			
			public void SetCancelDeliveryReq(vipapis.delivery.CancelDeliveryReq value){
				this.cancelDeliveryReq_ = value;
			}
		...
		public class createPoDeliveryV2_args {
			
			///<summary>
			/// 创建出仓单2.0请求
			///</summary>
			
			private vipapis.delivery.CreatePoDeliveryReq createPoDeliveryReq_;
			
			public vipapis.delivery.CreatePoDeliveryReq GetCreatePoDeliveryReq(){
				return this.createPoDeliveryReq_;
			}
			
			public void SetCreatePoDeliveryReq(vipapis.delivery.CreatePoDeliveryReq value){
				this.createPoDeliveryReq_ = value;
			}
		...
		public class editPoDeliveryV2_args {
			
			///<summary>
			/// 编辑出仓库单请求
			///</summary>
			
			private vipapis.delivery.EditDeliveryReq editDeliveryReq_;
			
			public vipapis.delivery.EditDeliveryReq GetEditDeliveryReq(){
				return this.editDeliveryReq_;
			}
			
			public void SetEditDeliveryReq(vipapis.delivery.EditDeliveryReq value){
				this.editDeliveryReq_ = value;
			}
		...
		public class cancelDelivery_result {
			
			///<summary>
			///</summary>
			
			private vipapis.delivery.CancelDeliveryResp success_;
			
			public vipapis.delivery.CancelDeliveryResp GetSuccess(){
				return this.success_;
			}
			
			public void SetSuccess(vipapis.delivery.CancelDeliveryResp value){
				this.success_ = value;
			}
		...
		public class createPoDeliveryV2_result {
			
			///<summary>
			///</summary>
			
			private vipapis.delivery.CreatePoDeliveryResp success_;
			
			public vipapis.delivery.CreatePoDeliveryResp GetSuccess(){
				return this.success_;
			}
			
			public void SetSuccess(vipapis.delivery.CreatePoDeliveryResp value){
				this.success_ = value;
			}
		...
		public class editPoDeliveryV2_result {
			
			///<summary>
			///</summary>
			
			private vipapis.delivery.EditDeliveryResp success_;
			
			public vipapis.delivery.EditDeliveryResp GetSuccess(){
				return this.success_;
			}
			
			public void SetSuccess(vipapis.delivery.EditDeliveryResp value){
				this.success_ = value;
			}
		...
		public class cancelDelivery_argsHelper : TBeanSerializer<cancelDelivery_args>
		{
			
			public static cancelDelivery_argsHelper OBJ = new cancelDelivery_argsHelper();
			
			public static cancelDelivery_argsHelper getInstance() {
				
				return OBJ;
			}
			
			
			public void Read(cancelDelivery_args structs, Protocol iprot){
				...
				if(true){
					...
					vipapis.delivery.CancelDeliveryReq value;
					
					value = new vipapis.delivery.CancelDeliveryReq();
					vipapis.delivery.CancelDeliveryReqHelper.getInstance().Read(value, iprot);
					
					structs.SetCancelDeliveryReq(value);
				}
			...
			public void Write(cancelDelivery_args structs, Protocol oprot){
				
				Validate(structs);
				oprot.WriteStructBegin();
				
				if(structs.GetCancelDeliveryReq() != null) {
					
					oprot.WriteFieldBegin("cancelDeliveryReq");
					
					vipapis.delivery.CancelDeliveryReqHelper.getInstance().Write(structs.GetCancelDeliveryReq(), oprot);
					
					oprot.WriteFieldEnd();
				}
				
				else{
					throw new ArgumentException("cancelDeliveryReq can not be null!");
				}
			...
			public void Validate(cancelDelivery_args bean){
		...
		public class createPoDeliveryV2_argsHelper : TBeanSerializer<createPoDeliveryV2_args>
		{
			
			public static createPoDeliveryV2_argsHelper OBJ = new createPoDeliveryV2_argsHelper();
			
			public static createPoDeliveryV2_argsHelper getInstance() {
				
				return OBJ;
			}
			
			
			public void Read(createPoDeliveryV2_args structs, Protocol iprot){
				...
				if(true){
					...
					vipapis.delivery.CreatePoDeliveryReq value;
					
					value = new vipapis.delivery.CreatePoDeliveryReq();
					vipapis.delivery.CreatePoDeliveryReqHelper.getInstance().Read(value, iprot);
					
					structs.SetCreatePoDeliveryReq(value);
				}
			...
			public void Write(createPoDeliveryV2_args structs, Protocol oprot){
				
				Validate(structs);
				oprot.WriteStructBegin();
				
				if(structs.GetCreatePoDeliveryReq() != null) {
					
					oprot.WriteFieldBegin("createPoDeliveryReq");
					
					vipapis.delivery.CreatePoDeliveryReqHelper.getInstance().Write(structs.GetCreatePoDeliveryReq(), oprot);
					
					oprot.WriteFieldEnd();
				}
				
				else{
					throw new ArgumentException("createPoDeliveryReq can not be null!");
				}
			...
			public void Validate(createPoDeliveryV2_args bean){
		...
		public class editPoDeliveryV2_argsHelper : TBeanSerializer<editPoDeliveryV2_args>
		{
			
			public static editPoDeliveryV2_argsHelper OBJ = new editPoDeliveryV2_argsHelper();
			
			public static editPoDeliveryV2_argsHelper getInstance() {
				
				return OBJ;
			}
			
			
			public void Read(editPoDeliveryV2_args structs, Protocol iprot){
				...
				if(true){
					...
					vipapis.delivery.EditDeliveryReq value;
					
					value = new vipapis.delivery.EditDeliveryReq();
					vipapis.delivery.EditDeliveryReqHelper.getInstance().Read(value, iprot);
					
					structs.SetEditDeliveryReq(value);
				}
			...
			public void Write(editPoDeliveryV2_args structs, Protocol oprot){
				
				Validate(structs);
				oprot.WriteStructBegin();
				
				if(structs.GetEditDeliveryReq() != null) {
					
					oprot.WriteFieldBegin("editDeliveryReq");
					
					vipapis.delivery.EditDeliveryReqHelper.getInstance().Write(structs.GetEditDeliveryReq(), oprot);
					
					oprot.WriteFieldEnd();
				}
				
				else{
					throw new ArgumentException("editDeliveryReq can not be null!");
				}
			...
			public void Validate(editPoDeliveryV2_args bean){
		...
		public class cancelDelivery_resultHelper : TBeanSerializer<cancelDelivery_result>
		{
			
			public static cancelDelivery_resultHelper OBJ = new cancelDelivery_resultHelper();
			
			public static cancelDelivery_resultHelper getInstance() {
				
				return OBJ;
			}
			
			
			public void Read(cancelDelivery_result structs, Protocol iprot){
				...
				if(true){
					...
					vipapis.delivery.CancelDeliveryResp value;
					
					value = new vipapis.delivery.CancelDeliveryResp();
					vipapis.delivery.CancelDeliveryRespHelper.getInstance().Read(value, iprot);
			...
			public void Write(cancelDelivery_result structs, Protocol oprot){
				...
				if(structs.GetSuccess() != null) {
					...
					vipapis.delivery.CancelDeliveryRespHelper.getInstance().Write(structs.GetSuccess(), oprot);
			...
			public void Validate(cancelDelivery_result bean){
		...
		public class createPoDeliveryV2_resultHelper : TBeanSerializer<createPoDeliveryV2_result>
		{
			
			public static createPoDeliveryV2_resultHelper OBJ = new createPoDeliveryV2_resultHelper();
			
			public static createPoDeliveryV2_resultHelper getInstance() {
				
				return OBJ;
			}
			
			
			public void Read(createPoDeliveryV2_result structs, Protocol iprot){
				...
				if(true){
					...
					vipapis.delivery.CreatePoDeliveryResp value;
					
					value = new vipapis.delivery.CreatePoDeliveryResp();
					vipapis.delivery.CreatePoDeliveryRespHelper.getInstance().Read(value, iprot);
			...
			public void Write(createPoDeliveryV2_result structs, Protocol oprot){
				...
				if(structs.GetSuccess() != null) {
					...
					vipapis.delivery.CreatePoDeliveryRespHelper.getInstance().Write(structs.GetSuccess(), oprot);
			...
			public void Validate(createPoDeliveryV2_result bean){
				...
				if(true){
					...
					while(true){
						...
						try{
							...
							vipapis.delivery.DeleteDeliveryDetail elem0;
							
							elem0 = new vipapis.delivery.DeleteDeliveryDetail();
							vipapis.delivery.DeleteDeliveryDetailHelper.getInstance().Read(elem0, iprot);
		...
		public class editPoDeliveryV2_resultHelper : TBeanSerializer<editPoDeliveryV2_result>
		{
			
			public static editPoDeliveryV2_resultHelper OBJ = new editPoDeliveryV2_resultHelper();
			
			public static editPoDeliveryV2_resultHelper getInstance() {
				
				return OBJ;
			}
			
			
			public void Read(editPoDeliveryV2_result structs, Protocol iprot){
				...
				if(true){
					...
					vipapis.delivery.EditDeliveryResp value;
					
					value = new vipapis.delivery.EditDeliveryResp();
					vipapis.delivery.EditDeliveryRespHelper.getInstance().Read(value, iprot);
			...
			public void Write(editPoDeliveryV2_result structs, Protocol oprot){
				...
				if(structs.GetSuccess() != null) {
					...
					vipapis.delivery.EditDeliveryRespHelper.getInstance().Write(structs.GetSuccess(), oprot);
			...
			public void Validate(editPoDeliveryV2_result bean){
		...
		public class JitDeliveryServiceClient : OspRestStub , JitDeliveryService  {
			...
			public vipapis.delivery.CancelDeliveryResp cancelDelivery(vipapis.delivery.CancelDeliveryReq cancelDeliveryReq_) {
				
				send_cancelDelivery(cancelDeliveryReq_);
				return recv_cancelDelivery(); 
				
			}
			
			
			private void send_cancelDelivery(vipapis.delivery.CancelDeliveryReq cancelDeliveryReq_){
				
				InitInvocation("cancelDelivery");
				
				cancelDelivery_args args = new cancelDelivery_args();
				args.SetCancelDeliveryReq(cancelDeliveryReq_);
				
				SendBase(args, cancelDelivery_argsHelper.getInstance());
			}
			
			
			private vipapis.delivery.CancelDeliveryResp recv_cancelDelivery(){
				
				cancelDelivery_result result = new cancelDelivery_result();
				ReceiveBase(result, cancelDelivery_resultHelper.getInstance());
			...
			public vipapis.delivery.CreateDeliveryResponse createDelivery(int vendor_id_,string po_no_,string delivery_no_,vipapis.common.Warehouse? warehouse_,string delivery_time_,string arrival_time_,string race_time_,string carrier_name_,string tel_,string driver_,string driver_tel_,string plate_number_,int? page_,int? limit_,string delivery_method_,string store_sn_,string carrier_code_,int? jit_type_) {
				
				send_createDelivery(vendor_id_,po_no_,delivery_no_,warehouse_,delivery_time_,arrival_time_,race_time_,carrier_name_,tel_,driver_,driver_tel_,plate_number_,page_,limit_,delivery_method_,store_sn_,carrier_code_,jit_type_);
			...
			public vipapis.delivery.CreatePoDeliveryResp createPoDeliveryV2(vipapis.delivery.CreatePoDeliveryReq createPoDeliveryReq_) {
				
				send_createPoDeliveryV2(createPoDeliveryReq_);
				return recv_createPoDeliveryV2(); 
				
			}
			
			
			private void send_createPoDeliveryV2(vipapis.delivery.CreatePoDeliveryReq createPoDeliveryReq_){
				
				InitInvocation("createPoDeliveryV2");
				
				createPoDeliveryV2_args args = new createPoDeliveryV2_args();
				args.SetCreatePoDeliveryReq(createPoDeliveryReq_);
				
				SendBase(args, createPoDeliveryV2_argsHelper.getInstance());
			}
			
			
			private vipapis.delivery.CreatePoDeliveryResp recv_createPoDeliveryV2(){
				
				createPoDeliveryV2_result result = new createPoDeliveryV2_result();
				ReceiveBase(result, createPoDeliveryV2_resultHelper.getInstance());
			...
			public vipapis.delivery.EditDeliveryResp editPoDeliveryV2(vipapis.delivery.EditDeliveryReq editDeliveryReq_) {
				
				send_editPoDeliveryV2(editDeliveryReq_);
				return recv_editPoDeliveryV2(); 
				
			}
			
			
			private void send_editPoDeliveryV2(vipapis.delivery.EditDeliveryReq editDeliveryReq_){
				
				InitInvocation("editPoDeliveryV2");
				
				editPoDeliveryV2_args args = new editPoDeliveryV2_args();
				args.SetEditDeliveryReq(editDeliveryReq_);
				
				SendBase(args, editPoDeliveryV2_argsHelper.getInstance());
			}
			
			
			private vipapis.delivery.EditDeliveryResp recv_editPoDeliveryV2(){
				
				editPoDeliveryV2_result result = new editPoDeliveryV2_result();
				ReceiveBase(result, editPoDeliveryV2_resultHelper.getInstance());
