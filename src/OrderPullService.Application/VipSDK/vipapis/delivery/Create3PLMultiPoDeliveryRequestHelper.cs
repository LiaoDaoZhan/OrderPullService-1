...
namespace vipapis.delivery{
	...
	public class Create3PLMultiPoDeliveryRequestHelper : TBeanSerializer<Create3PLMultiPoDeliveryRequest>
	{
		
		public static Create3PLMultiPoDeliveryRequestHelper OBJ = new Create3PLMultiPoDeliveryRequestHelper();
		...
		public void Read(Create3PLMultiPoDeliveryRequest structs, Protocol iprot){
		...
		public void Write(Create3PLMultiPoDeliveryRequest structs, Protocol oprot){
		...
		public void Validate(Create3PLMultiPoDeliveryRequest bean){
