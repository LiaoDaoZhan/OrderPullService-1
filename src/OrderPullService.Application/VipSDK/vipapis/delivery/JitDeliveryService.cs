...
namespace vipapis.delivery{
	...
	public interface JitDeliveryService {
		...
		vipapis.delivery.CancelDeliveryResp cancelDelivery( vipapis.delivery.CancelDeliveryReq cancelDeliveryReq_ );
		...
		vipapis.delivery.CreatePoDeliveryResp createPoDeliveryV2( vipapis.delivery.CreatePoDeliveryReq createPoDeliveryReq_ );
		...
		vipapis.delivery.EditDeliveryResp editPoDeliveryV2( vipapis.delivery.EditDeliveryReq editDeliveryReq_ );
