					...
					if ("availableInventoryList".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.normal.AvailableInventory elem0;
								
								elem0 = new vipapis.normal.AvailableInventory();
								vipapis.normal.AvailableInventoryHelper.getInstance().Read(elem0, iprot);
