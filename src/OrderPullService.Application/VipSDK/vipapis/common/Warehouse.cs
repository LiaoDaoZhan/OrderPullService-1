	...
	public class WarehouseUtil{
		...
		public static Warehouse? FindByValue(int value){
			...
			switch(value){
				...
				case 53: return Warehouse.VIP_KTNH; 
				case 54: return Warehouse.VIP_XA; 
		...
		public static Warehouse? FindByName(string name){
			...
			if(Warehouse.VIP_KTNH.ToString().Equals(name)){
				
				return Warehouse.VIP_KTNH; 
			}
			
			if(Warehouse.VIP_XA.ToString().Equals(name)){
				
				return Warehouse.VIP_XA; 
			}
