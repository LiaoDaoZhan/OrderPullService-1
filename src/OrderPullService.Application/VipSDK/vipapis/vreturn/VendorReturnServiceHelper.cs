...
namespace vipapis.vreturn{
	...
	public class VendorReturnServiceHelper {
		...
		public class getReturnDetail_args {
			...
			///<summary>
			/// 仓库
			/// @sampleValue warehouse warehouse=VIP_NH,退供仓库只支持下面仓库(VIP_NH, VIP_SH, VIP_CD, VIP_HZ, VIP_BJ, VIP_HK，VIP_TYO，VIP_NYC，VIP_PAR，VIP_SEL，VIP_SYD，VIP_LON，VIP_FRA，VIP_MIL，VIP_SY, VIP_KTNH, VIP_XA)
			///</summary>
