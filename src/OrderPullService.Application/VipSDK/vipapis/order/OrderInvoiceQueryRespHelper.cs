					...
					if ("success_list".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.order.OrderInvoiceResp elem0;
								
								elem0 = new vipapis.order.OrderInvoiceResp();
								vipapis.order.OrderInvoiceRespHelper.getInstance().Read(elem0, iprot);
					...
					if ("fail_list".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.order.FailQueryItem elem2;
								
								elem2 = new vipapis.order.FailQueryItem();
								vipapis.order.FailQueryItemHelper.getInstance().Read(elem2, iprot);
