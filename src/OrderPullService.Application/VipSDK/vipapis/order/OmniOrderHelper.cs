...
namespace vipapis.order{
	...
	public class OmniOrderHelper : TBeanSerializer<OmniOrder>
	{
		
		public static OmniOrderHelper OBJ = new OmniOrderHelper();
		...
		public void Write(OmniOrder structs, Protocol oprot){
		...
		public void Validate(OmniOrder bean){
