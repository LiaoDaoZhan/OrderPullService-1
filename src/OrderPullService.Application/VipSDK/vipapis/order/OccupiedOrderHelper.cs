...
namespace vipapis.order{
	...
	public class OccupiedOrderHelper : TBeanSerializer<OccupiedOrder>
	{
		...
		public void Read(OccupiedOrder structs, Protocol iprot){
			...
			if(schemeStruct != null){
				...
				while(true){
					...
					if ("parent_order_id".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetParent_order_id(value);
					}
		...
		public void Write(OccupiedOrder structs, Protocol oprot){
			...
			if(structs.GetParent_order_id() != null) {
				
				oprot.WriteFieldBegin("parent_order_id");
				oprot.WriteString(structs.GetParent_order_id());
