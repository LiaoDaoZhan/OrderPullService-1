...
namespace vipapis.order{
	...
	public class InventoryOccupiedOrdersRequest {
		...
		private byte? business_channel_;
		...
		public byte? GetBusiness_channel(){
			return this.business_channel_;
		}
		
		public void SetBusiness_channel(byte? value){
			this.business_channel_ = value;
		}
