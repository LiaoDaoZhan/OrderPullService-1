...
namespace vipapis.fcs{
	...
	public interface VeiService {
		...
		com.vip.fcs.vei.service.DownloadElectronicInvoiceResModel downloadElectronicInvoiceInNewProcess( com.vip.fcs.vei.service.DownloadElectronicInvoiceReqModel reqModel_ );
		...
		com.vip.fcs.vei.service.ExternalInvoiceHandleStateResModel getExternalInvoiceHandleStateExt( com.vip.fcs.vei.service.ExternalInvoiceHandleStateReqModelExt reqModel_ );
