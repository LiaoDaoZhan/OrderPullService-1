...
namespace vipapis.fcs{
	...
	public class VeiServiceHelper {
		...
		public class downloadElectronicInvoiceInNewProcess_args {
		...
		public class getExternalInvoiceHandleStateExt_args {
			
			///<summary>
			///</summary>
			
			private com.vip.fcs.vei.service.ExternalInvoiceHandleStateReqModelExt reqModel_;
			
			public com.vip.fcs.vei.service.ExternalInvoiceHandleStateReqModelExt GetReqModel(){
				return this.reqModel_;
			}
			
			public void SetReqModel(com.vip.fcs.vei.service.ExternalInvoiceHandleStateReqModelExt value){
				this.reqModel_ = value;
			}
		...
		public class downloadElectronicInvoiceInNewProcess_result {
		...
		public class getExternalInvoiceHandleStateExt_result {
		...
		public class downloadElectronicInvoiceInNewProcess_argsHelper : TBeanSerializer<downloadElectronicInvoiceInNewProcess_args>
		{
			
			public static downloadElectronicInvoiceInNewProcess_argsHelper OBJ = new downloadElectronicInvoiceInNewProcess_argsHelper();
			...
			public void Read(downloadElectronicInvoiceInNewProcess_args structs, Protocol iprot){
			...
			public void Write(downloadElectronicInvoiceInNewProcess_args structs, Protocol oprot){
			...
			public void Validate(downloadElectronicInvoiceInNewProcess_args bean){
		...
		public class getExternalInvoiceHandleStateExt_argsHelper : TBeanSerializer<getExternalInvoiceHandleStateExt_args>
		{
			
			public static getExternalInvoiceHandleStateExt_argsHelper OBJ = new getExternalInvoiceHandleStateExt_argsHelper();
			...
			public void Read(getExternalInvoiceHandleStateExt_args structs, Protocol iprot){
				...
				if(true){
					...
					com.vip.fcs.vei.service.ExternalInvoiceHandleStateReqModelExt value;
					
					value = new com.vip.fcs.vei.service.ExternalInvoiceHandleStateReqModelExt();
					com.vip.fcs.vei.service.ExternalInvoiceHandleStateReqModelExtHelper.getInstance().Read(value, iprot);
			...
			public void Write(getExternalInvoiceHandleStateExt_args structs, Protocol oprot){
				...
				if(structs.GetReqModel() != null) {
					...
					com.vip.fcs.vei.service.ExternalInvoiceHandleStateReqModelExtHelper.getInstance().Write(structs.GetReqModel(), oprot);
			...
			public void Validate(getExternalInvoiceHandleStateExt_args bean){
		...
		public class downloadElectronicInvoiceInNewProcess_resultHelper : TBeanSerializer<downloadElectronicInvoiceInNewProcess_result>
		{
			
			public static downloadElectronicInvoiceInNewProcess_resultHelper OBJ = new downloadElectronicInvoiceInNewProcess_resultHelper();
			...
			public void Read(downloadElectronicInvoiceInNewProcess_result structs, Protocol iprot){
			...
			public void Write(downloadElectronicInvoiceInNewProcess_result structs, Protocol oprot){
			...
			public void Validate(downloadElectronicInvoiceInNewProcess_result bean){
		...
		public class getExternalInvoiceHandleStateExt_resultHelper : TBeanSerializer<getExternalInvoiceHandleStateExt_result>
		{
			
			public static getExternalInvoiceHandleStateExt_resultHelper OBJ = new getExternalInvoiceHandleStateExt_resultHelper();
			...
			public void Read(getExternalInvoiceHandleStateExt_result structs, Protocol iprot){
			...
			public void Write(getExternalInvoiceHandleStateExt_result structs, Protocol oprot){
			...
			public void Validate(getExternalInvoiceHandleStateExt_result bean){
		...
		public class VeiServiceClient : OspRestStub , VeiService  {
			...
			public com.vip.fcs.vei.service.DownloadElectronicInvoiceResModel downloadElectronicInvoiceInNewProcess(com.vip.fcs.vei.service.DownloadElectronicInvoiceReqModel reqModel_) {
				
				send_downloadElectronicInvoiceInNewProcess(reqModel_);
				return recv_downloadElectronicInvoiceInNewProcess(); 
				
			}
			
			
			private void send_downloadElectronicInvoiceInNewProcess(com.vip.fcs.vei.service.DownloadElectronicInvoiceReqModel reqModel_){
				
				InitInvocation("downloadElectronicInvoiceInNewProcess");
				
				downloadElectronicInvoiceInNewProcess_args args = new downloadElectronicInvoiceInNewProcess_args();
				args.SetReqModel(reqModel_);
				
				SendBase(args, downloadElectronicInvoiceInNewProcess_argsHelper.getInstance());
			}
			
			
			private com.vip.fcs.vei.service.DownloadElectronicInvoiceResModel recv_downloadElectronicInvoiceInNewProcess(){
				
				downloadElectronicInvoiceInNewProcess_result result = new downloadElectronicInvoiceInNewProcess_result();
				ReceiveBase(result, downloadElectronicInvoiceInNewProcess_resultHelper.getInstance());
			...
			public com.vip.fcs.vei.service.ExternalInvoiceHandleStateResModel getExternalInvoiceHandleStateExt(com.vip.fcs.vei.service.ExternalInvoiceHandleStateReqModelExt reqModel_) {
				
				send_getExternalInvoiceHandleStateExt(reqModel_);
				return recv_getExternalInvoiceHandleStateExt(); 
				
			}
			
			
			private void send_getExternalInvoiceHandleStateExt(com.vip.fcs.vei.service.ExternalInvoiceHandleStateReqModelExt reqModel_){
				
				InitInvocation("getExternalInvoiceHandleStateExt");
				
				getExternalInvoiceHandleStateExt_args args = new getExternalInvoiceHandleStateExt_args();
				args.SetReqModel(reqModel_);
				
				SendBase(args, getExternalInvoiceHandleStateExt_argsHelper.getInstance());
			}
			
			
			private com.vip.fcs.vei.service.ExternalInvoiceHandleStateResModel recv_getExternalInvoiceHandleStateExt(){
				
				getExternalInvoiceHandleStateExt_result result = new getExternalInvoiceHandleStateExt_result();
				ReceiveBase(result, getExternalInvoiceHandleStateExt_resultHelper.getInstance());
