...
namespace vipapis.puma{
	...
	public class VendorProduct {
		...
		private Dictionary<int?, string> square_images_;
		
		///<summary>
		/// 长图
		///</summary>
		
		private Dictionary<int?, string> rectangle_images_;
		
		///<summary>
		/// 商品详情图片
		///</summary>
		
		private Dictionary<int?, string> detailed_Images_;
		...
		public Dictionary<int?, string> GetSquare_images(){
			return this.square_images_;
		}
		
		public void SetSquare_images(Dictionary<int?, string> value){
			this.square_images_ = value;
		}
		public Dictionary<int?, string> GetRectangle_images(){
			return this.rectangle_images_;
		}
		
		public void SetRectangle_images(Dictionary<int?, string> value){
			this.rectangle_images_ = value;
		}
		public Dictionary<int?, string> GetDetailed_Images(){
			return this.detailed_Images_;
		}
		
		public void SetDetailed_Images(Dictionary<int?, string> value){
			this.detailed_Images_ = value;
		}
