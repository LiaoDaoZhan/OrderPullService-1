...
namespace vipapis.puma{
	...
	public class NumberRangeHelper : TBeanSerializer<NumberRange>
	{
		
		public static NumberRangeHelper OBJ = new NumberRangeHelper();
		...
		public void Read(NumberRange structs, Protocol iprot){
		...
		public void Write(NumberRange structs, Protocol oprot){
		...
		public void Validate(NumberRange bean){
