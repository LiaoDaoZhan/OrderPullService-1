...
namespace vipapis.inventory{
	...
	public interface InventoryService {
		...
		vipapis.inventory.GetAdvisedSkuListResult getAdvisedSkuList( int vendor_id_,   int cooperation_no_,   string warehouse_ );
		
		vipapis.inventory.GetCooperationNoListResponse getCooperationNoList( vipapis.inventory.GetCooperationNoListRequest getCooperationNoListRequest_ );
