...
namespace vipapis.inventory{
	...
	public class OccupiedOrderHelper : TBeanSerializer<OccupiedOrder>
	{
		...
		public void Read(OccupiedOrder structs, Protocol iprot){
			...
			if(schemeStruct != null){
				...
				while(true){
					...
					if ("hold_flag".Equals(schemeField.Trim())){
						
						needSkip = false;
						byte? value;
						value = iprot.ReadByte(); 
						
						structs.SetHold_flag(value);
					}
		...
		public void Write(OccupiedOrder structs, Protocol oprot){
			...
			if(structs.GetHold_flag() != null) {
				
				oprot.WriteFieldBegin("hold_flag");
				oprot.WriteByte((byte)structs.GetHold_flag()); 
