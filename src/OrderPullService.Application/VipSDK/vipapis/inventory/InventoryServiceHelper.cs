...
namespace vipapis.inventory{
	...
	public class InventoryServiceHelper {
		...
		public class getAdvisedSkuList_args {
		...
		public class getCooperationNoList_args {
			
			///<summary>
			/// 获取合作编码信息请求参数
			///</summary>
			
			private vipapis.inventory.GetCooperationNoListRequest getCooperationNoListRequest_;
			
			public vipapis.inventory.GetCooperationNoListRequest GetGetCooperationNoListRequest(){
				return this.getCooperationNoListRequest_;
			}
			
			public void SetGetCooperationNoListRequest(vipapis.inventory.GetCooperationNoListRequest value){
				this.getCooperationNoListRequest_ = value;
			}
		...
		public class getAdvisedSkuList_result {
			
			///<summary>
			///</summary>
			
			private vipapis.inventory.GetAdvisedSkuListResult success_;
			
			public vipapis.inventory.GetAdvisedSkuListResult GetSuccess(){
				return this.success_;
			}
			
			public void SetSuccess(vipapis.inventory.GetAdvisedSkuListResult value){
				this.success_ = value;
			}
		...
		public class getCooperationNoList_result {
			
			///<summary>
			///</summary>
			
			private vipapis.inventory.GetCooperationNoListResponse success_;
			
			public vipapis.inventory.GetCooperationNoListResponse GetSuccess(){
				return this.success_;
			}
			
			public void SetSuccess(vipapis.inventory.GetCooperationNoListResponse value){
				this.success_ = value;
			}
		...
		public class getAdvisedSkuList_argsHelper : TBeanSerializer<getAdvisedSkuList_args>
		{
			
			public static getAdvisedSkuList_argsHelper OBJ = new getAdvisedSkuList_argsHelper();
			...
			public void Read(getAdvisedSkuList_args structs, Protocol iprot){
			...
			public void Write(getAdvisedSkuList_args structs, Protocol oprot){
			...
			public void Validate(getAdvisedSkuList_args bean){
		...
		public class getCooperationNoList_argsHelper : TBeanSerializer<getCooperationNoList_args>
		{
			
			public static getCooperationNoList_argsHelper OBJ = new getCooperationNoList_argsHelper();
			...
			public void Read(getCooperationNoList_args structs, Protocol iprot){
				...
				if(true){
					...
					vipapis.inventory.GetCooperationNoListRequest value;
					
					value = new vipapis.inventory.GetCooperationNoListRequest();
					vipapis.inventory.GetCooperationNoListRequestHelper.getInstance().Read(value, iprot);
					
					structs.SetGetCooperationNoListRequest(value);
				}
			...
			public void Write(getCooperationNoList_args structs, Protocol oprot){
				
				Validate(structs);
				oprot.WriteStructBegin();
				
				if(structs.GetGetCooperationNoListRequest() != null) {
					
					oprot.WriteFieldBegin("getCooperationNoListRequest");
					
					vipapis.inventory.GetCooperationNoListRequestHelper.getInstance().Write(structs.GetGetCooperationNoListRequest(), oprot);
			...
			public void Validate(getCooperationNoList_args bean){
		...
		public class getAdvisedSkuList_resultHelper : TBeanSerializer<getAdvisedSkuList_result>
		{
			
			public static getAdvisedSkuList_resultHelper OBJ = new getAdvisedSkuList_resultHelper();
			...
			public void Read(getAdvisedSkuList_result structs, Protocol iprot){
				...
				if(true){
					...
					vipapis.inventory.GetAdvisedSkuListResult value;
					
					value = new vipapis.inventory.GetAdvisedSkuListResult();
					vipapis.inventory.GetAdvisedSkuListResultHelper.getInstance().Read(value, iprot);
			...
			public void Write(getAdvisedSkuList_result structs, Protocol oprot){
				...
				if(structs.GetSuccess() != null) {
					...
					vipapis.inventory.GetAdvisedSkuListResultHelper.getInstance().Write(structs.GetSuccess(), oprot);
			...
			public void Validate(getAdvisedSkuList_result bean){
		...
		public class getCooperationNoList_resultHelper : TBeanSerializer<getCooperationNoList_result>
		{
			
			public static getCooperationNoList_resultHelper OBJ = new getCooperationNoList_resultHelper();
			...
			public void Read(getCooperationNoList_result structs, Protocol iprot){
				...
				if(true){
					...
					vipapis.inventory.GetCooperationNoListResponse value;
					
					value = new vipapis.inventory.GetCooperationNoListResponse();
					vipapis.inventory.GetCooperationNoListResponseHelper.getInstance().Read(value, iprot);
			...
			public void Write(getCooperationNoList_result structs, Protocol oprot){
				...
				if(structs.GetSuccess() != null) {
					...
					vipapis.inventory.GetCooperationNoListResponseHelper.getInstance().Write(structs.GetSuccess(), oprot);
			...
			public void Validate(getCooperationNoList_result bean){
		...
		public class InventoryServiceClient : OspRestStub , InventoryService  {
			...
			public vipapis.inventory.GetAdvisedSkuListResult getAdvisedSkuList(int vendor_id_,int cooperation_no_,string warehouse_) {
				
				send_getAdvisedSkuList(vendor_id_,cooperation_no_,warehouse_);
				return recv_getAdvisedSkuList(); 
				
			}
			
			
			private void send_getAdvisedSkuList(int vendor_id_,int cooperation_no_,string warehouse_){
				
				InitInvocation("getAdvisedSkuList");
				
				getAdvisedSkuList_args args = new getAdvisedSkuList_args();
				args.SetVendor_id(vendor_id_);
				args.SetCooperation_no(cooperation_no_);
				args.SetWarehouse(warehouse_);
				
				SendBase(args, getAdvisedSkuList_argsHelper.getInstance());
			}
			
			
			private vipapis.inventory.GetAdvisedSkuListResult recv_getAdvisedSkuList(){
				
				getAdvisedSkuList_result result = new getAdvisedSkuList_result();
				ReceiveBase(result, getAdvisedSkuList_resultHelper.getInstance());
			...
			public vipapis.inventory.GetCooperationNoListResponse getCooperationNoList(vipapis.inventory.GetCooperationNoListRequest getCooperationNoListRequest_) {
				
				send_getCooperationNoList(getCooperationNoListRequest_);
				return recv_getCooperationNoList(); 
				
			}
			
			
			private void send_getCooperationNoList(vipapis.inventory.GetCooperationNoListRequest getCooperationNoListRequest_){
				
				InitInvocation("getCooperationNoList");
				
				getCooperationNoList_args args = new getCooperationNoList_args();
				args.SetGetCooperationNoListRequest(getCooperationNoListRequest_);
				
				SendBase(args, getCooperationNoList_argsHelper.getInstance());
			}
			
			
			private vipapis.inventory.GetCooperationNoListResponse recv_getCooperationNoList(){
				
				getCooperationNoList_result result = new getCooperationNoList_result();
				ReceiveBase(result, getCooperationNoList_resultHelper.getInstance());
