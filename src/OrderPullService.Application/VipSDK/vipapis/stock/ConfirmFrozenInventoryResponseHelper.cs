					...
					if ("success_data".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.stock.ConfirmFrozenInventoryResult elem1;
								
								elem1 = new vipapis.stock.ConfirmFrozenInventoryResult();
								vipapis.stock.ConfirmFrozenInventoryResultHelper.getInstance().Read(elem1, iprot);
					...
					if ("fail_data".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.stock.ConfirmFrozenInventoryResult elem3;
								
								elem3 = new vipapis.stock.ConfirmFrozenInventoryResult();
								vipapis.stock.ConfirmFrozenInventoryResultHelper.getInstance().Read(elem3, iprot);
