...
namespace vipapis.stock{
	...
	public class GetOxoShopOrderForJitResponseHelper : TBeanSerializer<GetOxoShopOrderForJitResponse>
	{
					...
					if ("oxo_shop_order_for_jit_list".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.stock.OxoShopOrderForJitList elem1;
								
								elem1 = new vipapis.stock.OxoShopOrderForJitList();
								vipapis.stock.OxoShopOrderForJitListHelper.getInstance().Read(elem1, iprot);
