					...
					if ("success_data".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.stock.UpdateWarehouseInventoryResult elem1;
								
								elem1 = new vipapis.stock.UpdateWarehouseInventoryResult();
								vipapis.stock.UpdateWarehouseInventoryResultHelper.getInstance().Read(elem1, iprot);
					...
					if ("fail_data".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.stock.UpdateWarehouseInventoryResult elem3;
								
								elem3 = new vipapis.stock.UpdateWarehouseInventoryResult();
								vipapis.stock.UpdateWarehouseInventoryResultHelper.getInstance().Read(elem3, iprot);
