					...
					if ("oxo_shop_order_for_pop_list".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.stock.OxoShopOrderForPopList elem1;
								
								elem1 = new vipapis.stock.OxoShopOrderForPopList();
								vipapis.stock.OxoShopOrderForPopListHelper.getInstance().Read(elem1, iprot);
