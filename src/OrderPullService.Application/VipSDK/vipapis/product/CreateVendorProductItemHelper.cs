...
namespace vipapis.product{
	...
	public class CreateVendorProductItemHelper : TBeanSerializer<CreateVendorProductItem>
	{
		
		public static CreateVendorProductItemHelper OBJ = new CreateVendorProductItemHelper();
		
		public static CreateVendorProductItemHelper getInstance() {
		...
		public void Write(CreateVendorProductItem structs, Protocol oprot){
			...
			if(structs.GetProduct_props() != null) {
				...
				throw new ArgumentException("product_props can not be null!");
			}
		...
		public void Validate(CreateVendorProductItem bean){
