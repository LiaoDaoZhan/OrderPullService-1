					...
					if ("spu_image_list".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.product.ProductImage elem4;
								
								elem4 = new vipapis.product.ProductImage();
								vipapis.product.ProductImageHelper.getInstance().Read(elem4, iprot);
					...
					if ("color_image_list".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.product.ProductImage elem6;
								
								elem6 = new vipapis.product.ProductImage();
								vipapis.product.ProductImageHelper.getInstance().Read(elem6, iprot);
