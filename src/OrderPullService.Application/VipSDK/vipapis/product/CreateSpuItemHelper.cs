...
namespace vipapis.product{
	...
	public class CreateSpuItemHelper : TBeanSerializer<CreateSpuItem>
	{
		
		public static CreateSpuItemHelper OBJ = new CreateSpuItemHelper();
		...
		public void Read(CreateSpuItem structs, Protocol iprot){
					...
					if ("sku_item_list".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.product.CreateSkuItem elem3;
								
								elem3 = new vipapis.product.CreateSkuItem();
								vipapis.product.CreateSkuItemHelper.getInstance().Read(elem3, iprot);
					...
					if ("simple_product_props".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.product.SimpleProperty elem5;
								
								elem5 = new vipapis.product.SimpleProperty();
								vipapis.product.SimplePropertyHelper.getInstance().Read(elem5, iprot);
		...
		public void Write(CreateSpuItem structs, Protocol oprot){
		...
		public void Validate(CreateSpuItem bean){
