...
namespace vipapis.product{
	...
	public class EditVendorProductItemHelper : TBeanSerializer<EditVendorProductItem>
	{
		
		public static EditVendorProductItemHelper OBJ = new EditVendorProductItemHelper();
		
		public static EditVendorProductItemHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(EditVendorProductItem structs, Protocol iprot){
		...
		public void Write(EditVendorProductItem structs, Protocol oprot){
		...
		public void Validate(EditVendorProductItem bean){
