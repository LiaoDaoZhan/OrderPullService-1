...
namespace vipapis.xstore.cc.transferring.api{
	...
	public class UpdateTransOrderItemApiModelHelper : TBeanSerializer<UpdateTransOrderItemApiModel>
	{
		
		public static UpdateTransOrderItemApiModelHelper OBJ = new UpdateTransOrderItemApiModelHelper();
		...
		public void Read(UpdateTransOrderItemApiModel structs, Protocol iprot){
			...
			if(schemeStruct != null){
				...
				while(true){
					...
					if ("delivered_quantity".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetDelivered_quantity(value);
					}
		...
		public void Write(UpdateTransOrderItemApiModel structs, Protocol oprot){
			...
			if(structs.GetOut_purchase_no() != null) {
				...
				throw new ArgumentException("out_purchase_no can not be null!");
			}
			
			
			if(structs.GetDelivered_quantity() != null) {
				
				oprot.WriteFieldBegin("delivered_quantity");
				oprot.WriteString(structs.GetDelivered_quantity());
				
				oprot.WriteFieldEnd();
			}
			
			else{
				throw new ArgumentException("delivered_quantity can not be null!");
			}
		...
		public void Validate(UpdateTransOrderItemApiModel bean){
