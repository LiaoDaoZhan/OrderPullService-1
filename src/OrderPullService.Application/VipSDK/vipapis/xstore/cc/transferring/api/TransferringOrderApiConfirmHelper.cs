...
namespace vipapis.xstore.cc.transferring.api{
	...
	public class TransferringOrderApiConfirmHelper : TBeanSerializer<TransferringOrderApiConfirm>
	{
		
		public static TransferringOrderApiConfirmHelper OBJ = new TransferringOrderApiConfirmHelper();
		...
		public void Read(TransferringOrderApiConfirm structs, Protocol iprot){
		...
		public void Write(TransferringOrderApiConfirm structs, Protocol oprot){
		...
		public void Validate(TransferringOrderApiConfirm bean){
