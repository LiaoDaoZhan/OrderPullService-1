...
namespace vipapis.xstore.cc.transferring.api{
	...
	public class UpdateTransItemQtyApiInfoHelper : TBeanSerializer<UpdateTransItemQtyApiInfo>
	{
		
		public static UpdateTransItemQtyApiInfoHelper OBJ = new UpdateTransItemQtyApiInfoHelper();
		...
		public void Read(UpdateTransItemQtyApiInfo structs, Protocol iprot){
		...
		public void Write(UpdateTransItemQtyApiInfo structs, Protocol oprot){
		...
		public void Validate(UpdateTransItemQtyApiInfo bean){
