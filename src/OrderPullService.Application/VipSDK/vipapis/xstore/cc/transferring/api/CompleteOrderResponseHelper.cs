...
namespace vipapis.xstore.cc.transferring.api{
	...
	public class CompleteOrderResponseHelper : TBeanSerializer<CompleteOrderResponse>
	{
		
		public static CompleteOrderResponseHelper OBJ = new CompleteOrderResponseHelper();
		
		public static CompleteOrderResponseHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(CompleteOrderResponse structs, Protocol iprot){
		...
		public void Write(CompleteOrderResponse structs, Protocol oprot){
		...
		public void Validate(CompleteOrderResponse bean){
