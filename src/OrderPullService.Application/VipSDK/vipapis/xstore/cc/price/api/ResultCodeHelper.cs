...
namespace vipapis.xstore.cc.price.api{
	...
	public class ResultCodeHelper : TBeanSerializer<ResultCode>
	{
		
		public static ResultCodeHelper OBJ = new ResultCodeHelper();
		...
		public void Read(ResultCode structs, Protocol iprot){
		...
		public void Write(ResultCode structs, Protocol oprot){
		...
		public void Validate(ResultCode bean){
