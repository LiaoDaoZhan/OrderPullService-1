...
namespace vipapis.jitx{
	...
	public class BelleDeliveryOrderHelper : TBeanSerializer<BelleDeliveryOrder>
	{
		
		public static BelleDeliveryOrderHelper OBJ = new BelleDeliveryOrderHelper();
		...
		public void Read(BelleDeliveryOrder structs, Protocol iprot){
		...
		public void Write(BelleDeliveryOrder structs, Protocol oprot){
		...
		public void Validate(BelleDeliveryOrder bean){
