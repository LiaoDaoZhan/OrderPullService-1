...
namespace vipapis.jitx{
	...
	public class GetDeliveryOrdersRequestHelper : TBeanSerializer<GetDeliveryOrdersRequest>
	{
		
		public static GetDeliveryOrdersRequestHelper OBJ = new GetDeliveryOrdersRequestHelper();
		
		public static GetDeliveryOrdersRequestHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(GetDeliveryOrdersRequest structs, Protocol iprot){
		...
		public void Write(GetDeliveryOrdersRequest structs, Protocol oprot){
		...
		public void Validate(GetDeliveryOrdersRequest bean){
