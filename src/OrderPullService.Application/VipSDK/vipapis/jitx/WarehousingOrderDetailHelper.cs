...
namespace vipapis.jitx{
	...
	public class WarehousingOrderDetailHelper : TBeanSerializer<WarehousingOrderDetail>
	{
		
		public static WarehousingOrderDetailHelper OBJ = new WarehousingOrderDetailHelper();
		...
		public void Read(WarehousingOrderDetail structs, Protocol iprot){
		...
		public void Write(WarehousingOrderDetail structs, Protocol oprot){
		...
		public void Validate(WarehousingOrderDetail bean){
