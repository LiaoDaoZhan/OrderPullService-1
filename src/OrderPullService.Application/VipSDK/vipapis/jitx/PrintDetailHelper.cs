...
namespace vipapis.jitx{
	...
	public class PrintDetailHelper : TBeanSerializer<PrintDetail>
	{
		
		public static PrintDetailHelper OBJ = new PrintDetailHelper();
		...
		public void Read(PrintDetail structs, Protocol iprot){
		...
		public void Write(PrintDetail structs, Protocol oprot){
		...
		public void Validate(PrintDetail bean){
