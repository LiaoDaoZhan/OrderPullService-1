...
namespace vipapis.jitx{
	...
	public class BelleOrderHelper : TBeanSerializer<BelleOrder>
	{
		
		public static BelleOrderHelper OBJ = new BelleOrderHelper();
		
		public static BelleOrderHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(BelleOrder structs, Protocol iprot){
		...
		public void Write(BelleOrder structs, Protocol oprot){
		...
		public void Validate(BelleOrder bean){
