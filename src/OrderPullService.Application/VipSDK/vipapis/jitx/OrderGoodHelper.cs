...
namespace vipapis.jitx{
	...
	public class OrderGoodHelper : TBeanSerializer<OrderGood>
	{
		
		public static OrderGoodHelper OBJ = new OrderGoodHelper();
		...
		public void Read(OrderGood structs, Protocol iprot){
		...
		public void Write(OrderGood structs, Protocol oprot){
		...
		public void Validate(OrderGood bean){
