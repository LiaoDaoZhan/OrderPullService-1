...
namespace vipapis.jitx{
	...
	public class BelleOrderRequestHelper : TBeanSerializer<BelleOrderRequest>
	{
		
		public static BelleOrderRequestHelper OBJ = new BelleOrderRequestHelper();
		
		public static BelleOrderRequestHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(BelleOrderRequest structs, Protocol iprot){
		...
		public void Write(BelleOrderRequest structs, Protocol oprot){
		...
		public void Validate(BelleOrderRequest bean){
