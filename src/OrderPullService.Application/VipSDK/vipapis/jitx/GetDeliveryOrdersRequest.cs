...
namespace vipapis.jitx{
	...
	public class GetDeliveryOrdersRequest {
		...
		///<summary>
		/// JITX订单的类型：1=普通JITX，2=换货JITX，3=预付JITX，4=揽换JITX
		///</summary>
		
		private List<int?> order_types_;
		...
		public List<int?> GetOrder_types(){
			return this.order_types_;
		}
		
		public void SetOrder_types(List<int?> value){
			this.order_types_ = value;
		}
