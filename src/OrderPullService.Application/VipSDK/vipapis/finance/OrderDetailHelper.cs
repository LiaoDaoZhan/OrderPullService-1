...
namespace vipapis.finance{
	...
	public class OrderDetailHelper : TBeanSerializer<OrderDetail>
	{
		...
		public void Read(OrderDetail structs, Protocol iprot){
			...
			if(schemeStruct != null){
				...
				while(true){
					...
					if ("promotions".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.finance.Promotion elem1;
								
								elem1 = new vipapis.finance.Promotion();
								vipapis.finance.PromotionHelper.getInstance().Read(elem1, iprot);
					...
					if ("errors".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.finance.Error elem3;
								
								elem3 = new vipapis.finance.Error();
								vipapis.finance.ErrorHelper.getInstance().Read(elem3, iprot);
					...
					if ("virtual_money_paid".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetVirtual_money_paid(value);
					}
		...
		public void Write(OrderDetail structs, Protocol oprot){
			...
			if(structs.GetVirtual_money_paid() != null) {
				
				oprot.WriteFieldBegin("virtual_money_paid");
				oprot.WriteString(structs.GetVirtual_money_paid());
