					...
					if ("color_images".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.marketplace.product.ColorImage elem0;
								
								elem0 = new vipapis.marketplace.product.ColorImage();
								vipapis.marketplace.product.ColorImageHelper.getInstance().Read(elem0, iprot);
