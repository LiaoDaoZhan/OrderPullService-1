					...
					if ("skus".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.marketplace.product.AddSkuItem elem1;
								
								elem1 = new vipapis.marketplace.product.AddSkuItem();
								vipapis.marketplace.product.AddSkuItemHelper.getInstance().Read(elem1, iprot);
					...
					if ("color_images".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.marketplace.product.ColorImage elem3;
								
								elem3 = new vipapis.marketplace.product.ColorImage();
								vipapis.marketplace.product.ColorImageHelper.getInstance().Read(elem3, iprot);
