...
namespace vipapis.marketplace.product{
	...
	public class AddProductRequestHelper : TBeanSerializer<AddProductRequest>
	{
		...
		public void Read(AddProductRequest structs, Protocol iprot){
			...
			if(schemeStruct != null){
				...
				while(true){
					...
					if ("zone_sale_status".Equals(schemeField.Trim())){
						
						needSkip = false;
						int? value;
						value = iprot.ReadI32(); 
						
						structs.SetZone_sale_status(value);
					}
		...
		public void Write(AddProductRequest structs, Protocol oprot){
			...
			if(structs.GetZone_sale_status() != null) {
				
				oprot.WriteFieldBegin("zone_sale_status");
				oprot.WriteI32((int)structs.GetZone_sale_status()); 
