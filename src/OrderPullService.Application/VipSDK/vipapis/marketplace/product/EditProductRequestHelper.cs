					...
					if ("images".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.marketplace.product.Image elem4;
								
								elem4 = new vipapis.marketplace.product.Image();
								vipapis.marketplace.product.ImageHelper.getInstance().Read(elem4, iprot);
