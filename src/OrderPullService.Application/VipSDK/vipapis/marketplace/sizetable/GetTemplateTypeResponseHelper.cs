					...
					if ("template_types".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.marketplace.sizetable.TemplateType elem1;
								
								elem1 = new vipapis.marketplace.sizetable.TemplateType();
								vipapis.marketplace.sizetable.TemplateTypeHelper.getInstance().Read(elem1, iprot);
