...
namespace vipapis.marketplace.inventory{
	...
	public interface InventoryService {
		...
		vipapis.marketplace.inventory.IncreaseSkuStockResponse increaseSkuStock( vipapis.marketplace.inventory.IncreaseSkuStockRequest increaseSkuStockRequest_ );
