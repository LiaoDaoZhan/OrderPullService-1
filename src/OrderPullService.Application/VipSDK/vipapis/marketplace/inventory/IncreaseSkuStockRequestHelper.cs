...
namespace vipapis.marketplace.inventory{
	...
	public class IncreaseSkuStockRequestHelper : TBeanSerializer<IncreaseSkuStockRequest>
	{
		
		public static IncreaseSkuStockRequestHelper OBJ = new IncreaseSkuStockRequestHelper();
		...
		public void Read(IncreaseSkuStockRequest structs, Protocol iprot){
		...
		public void Write(IncreaseSkuStockRequest structs, Protocol oprot){
		...
		public void Validate(IncreaseSkuStockRequest bean){
