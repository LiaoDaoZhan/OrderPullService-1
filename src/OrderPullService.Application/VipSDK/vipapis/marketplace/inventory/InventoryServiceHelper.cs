...
namespace vipapis.marketplace.inventory{
	...
	public class InventoryServiceHelper {
		...
		public class increaseSkuStock_args {
			
			///<summary>
			/// 增量更新sku库存请求参数
			///</summary>
			
			private vipapis.marketplace.inventory.IncreaseSkuStockRequest increaseSkuStockRequest_;
			
			public vipapis.marketplace.inventory.IncreaseSkuStockRequest GetIncreaseSkuStockRequest(){
				return this.increaseSkuStockRequest_;
			}
			
			public void SetIncreaseSkuStockRequest(vipapis.marketplace.inventory.IncreaseSkuStockRequest value){
				this.increaseSkuStockRequest_ = value;
			}
		...
		public class increaseSkuStock_result {
			
			///<summary>
			///</summary>
			
			private vipapis.marketplace.inventory.IncreaseSkuStockResponse success_;
			
			public vipapis.marketplace.inventory.IncreaseSkuStockResponse GetSuccess(){
				return this.success_;
			}
			
			public void SetSuccess(vipapis.marketplace.inventory.IncreaseSkuStockResponse value){
				this.success_ = value;
			}
		...
		public class increaseSkuStock_argsHelper : TBeanSerializer<increaseSkuStock_args>
		{
			
			public static increaseSkuStock_argsHelper OBJ = new increaseSkuStock_argsHelper();
			...
			public void Read(increaseSkuStock_args structs, Protocol iprot){
				...
				if(true){
					...
					vipapis.marketplace.inventory.IncreaseSkuStockRequest value;
					
					value = new vipapis.marketplace.inventory.IncreaseSkuStockRequest();
					vipapis.marketplace.inventory.IncreaseSkuStockRequestHelper.getInstance().Read(value, iprot);
					
					structs.SetIncreaseSkuStockRequest(value);
				}
			...
			public void Write(increaseSkuStock_args structs, Protocol oprot){
				
				Validate(structs);
				oprot.WriteStructBegin();
				
				if(structs.GetIncreaseSkuStockRequest() != null) {
					
					oprot.WriteFieldBegin("increaseSkuStockRequest");
					
					vipapis.marketplace.inventory.IncreaseSkuStockRequestHelper.getInstance().Write(structs.GetIncreaseSkuStockRequest(), oprot);
					
					oprot.WriteFieldEnd();
				}
				
				else{
					throw new ArgumentException("increaseSkuStockRequest can not be null!");
				}
			...
			public void Validate(increaseSkuStock_args bean){
		...
		public class increaseSkuStock_resultHelper : TBeanSerializer<increaseSkuStock_result>
		{
			
			public static increaseSkuStock_resultHelper OBJ = new increaseSkuStock_resultHelper();
			...
			public void Read(increaseSkuStock_result structs, Protocol iprot){
				...
				if(true){
					...
					vipapis.marketplace.inventory.IncreaseSkuStockResponse value;
					
					value = new vipapis.marketplace.inventory.IncreaseSkuStockResponse();
					vipapis.marketplace.inventory.IncreaseSkuStockResponseHelper.getInstance().Read(value, iprot);
			...
			public void Write(increaseSkuStock_result structs, Protocol oprot){
				...
				if(structs.GetSuccess() != null) {
					...
					vipapis.marketplace.inventory.IncreaseSkuStockResponseHelper.getInstance().Write(structs.GetSuccess(), oprot);
			...
			public void Validate(increaseSkuStock_result bean){
		...
		public class InventoryServiceClient : OspRestStub , InventoryService  {
			...
			public vipapis.marketplace.inventory.IncreaseSkuStockResponse increaseSkuStock(vipapis.marketplace.inventory.IncreaseSkuStockRequest increaseSkuStockRequest_) {
				
				send_increaseSkuStock(increaseSkuStockRequest_);
				return recv_increaseSkuStock(); 
				
			}
			
			
			private void send_increaseSkuStock(vipapis.marketplace.inventory.IncreaseSkuStockRequest increaseSkuStockRequest_){
				
				InitInvocation("increaseSkuStock");
				
				increaseSkuStock_args args = new increaseSkuStock_args();
				args.SetIncreaseSkuStockRequest(increaseSkuStockRequest_);
				
				SendBase(args, increaseSkuStock_argsHelper.getInstance());
			}
			
			
			private vipapis.marketplace.inventory.IncreaseSkuStockResponse recv_increaseSkuStock(){
				
				increaseSkuStock_result result = new increaseSkuStock_result();
				ReceiveBase(result, increaseSkuStock_resultHelper.getInstance());
