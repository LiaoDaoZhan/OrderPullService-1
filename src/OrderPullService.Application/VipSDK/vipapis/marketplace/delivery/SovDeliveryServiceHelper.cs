...
namespace vipapis.marketplace.delivery{
	...
	public class SovDeliveryServiceHelper {
		...
		public class auditCancelApply_args {
			
			///<summary>
			/// 输入参数
			///</summary>
			
			private vipapis.marketplace.delivery.AuditCancelApplyRequest request_;
			
			public vipapis.marketplace.delivery.AuditCancelApplyRequest GetRequest(){
				return this.request_;
			}
			
			public void SetRequest(vipapis.marketplace.delivery.AuditCancelApplyRequest value){
				this.request_ = value;
			}
		...
		public class batchGetCancelInfo_args {
			
			///<summary>
			/// 输入参数
			///</summary>
			
			private vipapis.marketplace.delivery.BatchGetCancelInfoRequest request_;
			
			public vipapis.marketplace.delivery.BatchGetCancelInfoRequest GetRequest(){
				return this.request_;
			}
			
			public void SetRequest(vipapis.marketplace.delivery.BatchGetCancelInfoRequest value){
				this.request_ = value;
			}
		...
		public class decrypt_args {
			
			///<summary>
			/// 输入参数
			///</summary>
			
			private vipapis.marketplace.delivery.DecryptRequest request_;
			
			public vipapis.marketplace.delivery.DecryptRequest GetRequest(){
				return this.request_;
			}
			
			public void SetRequest(vipapis.marketplace.delivery.DecryptRequest value){
				this.request_ = value;
			}
		...
		public class getCancelInfo_args {
			
			///<summary>
			/// 输入参数
			///</summary>
			
			private vipapis.marketplace.delivery.GetCancelInfoRequest request_;
			
			public vipapis.marketplace.delivery.GetCancelInfoRequest GetRequest(){
				return this.request_;
			}
			
			public void SetRequest(vipapis.marketplace.delivery.GetCancelInfoRequest value){
				this.request_ = value;
			}
		...
		public class auditCancelApply_result {
		...
		public class batchGetCancelInfo_result {
			
			///<summary>
			///</summary>
			
			private vipapis.marketplace.delivery.BatchGetCancelInfoResponse success_;
			
			public vipapis.marketplace.delivery.BatchGetCancelInfoResponse GetSuccess(){
				return this.success_;
			}
			
			public void SetSuccess(vipapis.marketplace.delivery.BatchGetCancelInfoResponse value){
				this.success_ = value;
			}
		...
		public class decrypt_result {
			
			///<summary>
			///</summary>
			
			private List<vipapis.marketplace.delivery.DecryptData> success_;
			
			public List<vipapis.marketplace.delivery.DecryptData> GetSuccess(){
				return this.success_;
			}
			
			public void SetSuccess(List<vipapis.marketplace.delivery.DecryptData> value){
				this.success_ = value;
			}
		...
		public class getCancelInfo_result {
			
			///<summary>
			///</summary>
			
			private vipapis.marketplace.delivery.GetCancelInfoResponse success_;
			
			public vipapis.marketplace.delivery.GetCancelInfoResponse GetSuccess(){
				return this.success_;
			}
			
			public void SetSuccess(vipapis.marketplace.delivery.GetCancelInfoResponse value){
				this.success_ = value;
			}
		...
		public class auditCancelApply_argsHelper : TBeanSerializer<auditCancelApply_args>
		{
			
			public static auditCancelApply_argsHelper OBJ = new auditCancelApply_argsHelper();
			...
			public void Read(auditCancelApply_args structs, Protocol iprot){
				...
				if(true){
					...
					vipapis.marketplace.delivery.AuditCancelApplyRequest value;
					
					value = new vipapis.marketplace.delivery.AuditCancelApplyRequest();
					vipapis.marketplace.delivery.AuditCancelApplyRequestHelper.getInstance().Read(value, iprot);
			...
			public void Write(auditCancelApply_args structs, Protocol oprot){
				...
				if(structs.GetRequest() != null) {
					...
					vipapis.marketplace.delivery.AuditCancelApplyRequestHelper.getInstance().Write(structs.GetRequest(), oprot);
			...
			public void Validate(auditCancelApply_args bean){
		...
		public class batchGetCancelInfo_argsHelper : TBeanSerializer<batchGetCancelInfo_args>
		{
			
			public static batchGetCancelInfo_argsHelper OBJ = new batchGetCancelInfo_argsHelper();
			...
			public void Read(batchGetCancelInfo_args structs, Protocol iprot){
				...
				if(true){
					...
					vipapis.marketplace.delivery.BatchGetCancelInfoRequest value;
					
					value = new vipapis.marketplace.delivery.BatchGetCancelInfoRequest();
					vipapis.marketplace.delivery.BatchGetCancelInfoRequestHelper.getInstance().Read(value, iprot);
			...
			public void Write(batchGetCancelInfo_args structs, Protocol oprot){
				...
				if(structs.GetRequest() != null) {
					...
					vipapis.marketplace.delivery.BatchGetCancelInfoRequestHelper.getInstance().Write(structs.GetRequest(), oprot);
			...
			public void Validate(batchGetCancelInfo_args bean){
		...
		public class decrypt_argsHelper : TBeanSerializer<decrypt_args>
		{
			
			public static decrypt_argsHelper OBJ = new decrypt_argsHelper();
			...
			public void Read(decrypt_args structs, Protocol iprot){
				...
				if(true){
					...
					vipapis.marketplace.delivery.DecryptRequest value;
					
					value = new vipapis.marketplace.delivery.DecryptRequest();
					vipapis.marketplace.delivery.DecryptRequestHelper.getInstance().Read(value, iprot);
			...
			public void Write(decrypt_args structs, Protocol oprot){
				...
				if(structs.GetRequest() != null) {
					...
					vipapis.marketplace.delivery.DecryptRequestHelper.getInstance().Write(structs.GetRequest(), oprot);
			...
			public void Validate(decrypt_args bean){
		...
		public class getCancelInfo_argsHelper : TBeanSerializer<getCancelInfo_args>
		{
			
			public static getCancelInfo_argsHelper OBJ = new getCancelInfo_argsHelper();
			...
			public void Read(getCancelInfo_args structs, Protocol iprot){
				...
				if(true){
					...
					vipapis.marketplace.delivery.GetCancelInfoRequest value;
					
					value = new vipapis.marketplace.delivery.GetCancelInfoRequest();
					vipapis.marketplace.delivery.GetCancelInfoRequestHelper.getInstance().Read(value, iprot);
			...
			public void Write(getCancelInfo_args structs, Protocol oprot){
				...
				if(structs.GetRequest() != null) {
					...
					vipapis.marketplace.delivery.GetCancelInfoRequestHelper.getInstance().Write(structs.GetRequest(), oprot);
			...
			public void Validate(getCancelInfo_args bean){
		...
		public class auditCancelApply_resultHelper : TBeanSerializer<auditCancelApply_result>
		{
			
			public static auditCancelApply_resultHelper OBJ = new auditCancelApply_resultHelper();
			...
			public void Read(auditCancelApply_result structs, Protocol iprot){
			...
			public void Write(auditCancelApply_result structs, Protocol oprot){
			...
			public void Validate(auditCancelApply_result bean){
		...
		public class batchGetCancelInfo_resultHelper : TBeanSerializer<batchGetCancelInfo_result>
		{
			
			public static batchGetCancelInfo_resultHelper OBJ = new batchGetCancelInfo_resultHelper();
			...
			public void Read(batchGetCancelInfo_result structs, Protocol iprot){
				...
				if(true){
					...
					vipapis.marketplace.delivery.BatchGetCancelInfoResponse value;
					
					value = new vipapis.marketplace.delivery.BatchGetCancelInfoResponse();
					vipapis.marketplace.delivery.BatchGetCancelInfoResponseHelper.getInstance().Read(value, iprot);
			...
			public void Write(batchGetCancelInfo_result structs, Protocol oprot){
				...
				if(structs.GetSuccess() != null) {
					...
					vipapis.marketplace.delivery.BatchGetCancelInfoResponseHelper.getInstance().Write(structs.GetSuccess(), oprot);
			...
			public void Validate(batchGetCancelInfo_result bean){
		...
		public class decrypt_resultHelper : TBeanSerializer<decrypt_result>
		{
			
			public static decrypt_resultHelper OBJ = new decrypt_resultHelper();
			...
			public void Read(decrypt_result structs, Protocol iprot){
				...
				if(true){
					...
					List<vipapis.marketplace.delivery.DecryptData> value;
					
					value = new List<vipapis.marketplace.delivery.DecryptData>();
					iprot.ReadListBegin();
					while(true){
						
						try{
							
							vipapis.marketplace.delivery.DecryptData elem0;
							
							elem0 = new vipapis.marketplace.delivery.DecryptData();
							vipapis.marketplace.delivery.DecryptDataHelper.getInstance().Read(elem0, iprot);
			...
			public void Write(decrypt_result structs, Protocol oprot){
				...
				if(structs.GetSuccess() != null) {
					...
					foreach(vipapis.marketplace.delivery.DecryptData _item0 in structs.GetSuccess()){
						
						
						vipapis.marketplace.delivery.DecryptDataHelper.getInstance().Write(_item0, oprot);
			...
			public void Validate(decrypt_result bean){
		...
		public class getCancelInfo_resultHelper : TBeanSerializer<getCancelInfo_result>
		{
			
			public static getCancelInfo_resultHelper OBJ = new getCancelInfo_resultHelper();
			...
			public void Read(getCancelInfo_result structs, Protocol iprot){
				...
				if(true){
					...
					vipapis.marketplace.delivery.GetCancelInfoResponse value;
					
					value = new vipapis.marketplace.delivery.GetCancelInfoResponse();
					vipapis.marketplace.delivery.GetCancelInfoResponseHelper.getInstance().Read(value, iprot);
			...
			public void Write(getCancelInfo_result structs, Protocol oprot){
				...
				if(structs.GetSuccess() != null) {
					...
					vipapis.marketplace.delivery.GetCancelInfoResponseHelper.getInstance().Write(structs.GetSuccess(), oprot);
			...
			public void Validate(getCancelInfo_result bean){
		...
		public class SovDeliveryServiceClient : OspRestStub , SovDeliveryService  {
			...
			public void auditCancelApply(vipapis.marketplace.delivery.AuditCancelApplyRequest request_) {
				
				send_auditCancelApply(request_);
				recv_auditCancelApply();
				
			}
			
			
			private void send_auditCancelApply(vipapis.marketplace.delivery.AuditCancelApplyRequest request_){
				
				InitInvocation("auditCancelApply");
				
				auditCancelApply_args args = new auditCancelApply_args();
				args.SetRequest(request_);
				
				SendBase(args, auditCancelApply_argsHelper.getInstance());
			}
			
			
			private void recv_auditCancelApply(){
				
				auditCancelApply_result result = new auditCancelApply_result();
				ReceiveBase(result, auditCancelApply_resultHelper.getInstance());
				
				
			}
			
			
			public vipapis.marketplace.delivery.BatchGetCancelInfoResponse batchGetCancelInfo(vipapis.marketplace.delivery.BatchGetCancelInfoRequest request_) {
				
				send_batchGetCancelInfo(request_);
				return recv_batchGetCancelInfo(); 
				
			}
			
			
			private void send_batchGetCancelInfo(vipapis.marketplace.delivery.BatchGetCancelInfoRequest request_){
				
				InitInvocation("batchGetCancelInfo");
				
				batchGetCancelInfo_args args = new batchGetCancelInfo_args();
				args.SetRequest(request_);
				
				SendBase(args, batchGetCancelInfo_argsHelper.getInstance());
			}
			
			
			private vipapis.marketplace.delivery.BatchGetCancelInfoResponse recv_batchGetCancelInfo(){
				
				batchGetCancelInfo_result result = new batchGetCancelInfo_result();
				ReceiveBase(result, batchGetCancelInfo_resultHelper.getInstance());
			...
			public List<vipapis.marketplace.delivery.DecryptData> decrypt(vipapis.marketplace.delivery.DecryptRequest request_) {
				
				send_decrypt(request_);
				return recv_decrypt(); 
				
			}
			
			
			private void send_decrypt(vipapis.marketplace.delivery.DecryptRequest request_){
				...
				SendBase(args, decrypt_argsHelper.getInstance());
			}
			
			
			private List<vipapis.marketplace.delivery.DecryptData> recv_decrypt(){
				
				decrypt_result result = new decrypt_result();
				ReceiveBase(result, decrypt_resultHelper.getInstance());
			...
			public vipapis.marketplace.delivery.GetCancelInfoResponse getCancelInfo(vipapis.marketplace.delivery.GetCancelInfoRequest request_) {
				
				send_getCancelInfo(request_);
				return recv_getCancelInfo(); 
				
			}
			
			
			private void send_getCancelInfo(vipapis.marketplace.delivery.GetCancelInfoRequest request_){
				
				InitInvocation("getCancelInfo");
				
				getCancelInfo_args args = new getCancelInfo_args();
				args.SetRequest(request_);
				
				SendBase(args, getCancelInfo_argsHelper.getInstance());
			}
			
			
			private vipapis.marketplace.delivery.GetCancelInfoResponse recv_getCancelInfo(){
				
				getCancelInfo_result result = new getCancelInfo_result();
				ReceiveBase(result, getCancelInfo_resultHelper.getInstance());
