...
namespace vipapis.marketplace.delivery{
	...
	public class SovOrder {
		...
		private string open_user_id_;
		
		///<summary>
		/// 唯品币支付金额
		///</summary>
		
		private string vipmoney_;
		
		///<summary>
		/// 支付方式（可是使用的支付方式，唯品支付或者微信支付）
		///</summary>
		...
		private string invoice_deduct_money_;
		
		///<summary>
		/// 客户应付金额（客户应付金额=订单商品总金额+运费-优惠金额）
		///</summary>
		
		private string payable_fee_;
		...
		public string GetOpen_user_id(){
			return this.open_user_id_;
		}
		
		public void SetOpen_user_id(string value){
			this.open_user_id_ = value;
		}
		public string GetVipmoney(){
			return this.vipmoney_;
		}
		
		public void SetVipmoney(string value){
			this.vipmoney_ = value;
		}
		...
		public string GetInvoice_deduct_money(){
			return this.invoice_deduct_money_;
		}
		
		public void SetInvoice_deduct_money(string value){
			this.invoice_deduct_money_ = value;
		}
		public string GetPayable_fee(){
			return this.payable_fee_;
		}
		
		public void SetPayable_fee(string value){
