...
namespace vipapis.marketplace.delivery{
	...
	public class SovOrderHelper : TBeanSerializer<SovOrder>
	{
		...
		public void Read(SovOrder structs, Protocol iprot){
			...
			if(schemeStruct != null){
				...
				while(true){
					...
					if ("open_user_id".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetOpen_user_id(value);
					}
					...
					if ("vipmoney".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetVipmoney(value);
					}
					...
					if ("invoice_deduct_money".Equals(schemeField.Trim())){
						
						needSkip = false;
						string value;
						value = iprot.ReadString();
						
						structs.SetInvoice_deduct_money(value);
					}
					...
					if ("shipping_method".Equals(schemeField.Trim())){
						
						needSkip = false;
						int? value;
						value = iprot.ReadI32(); 
						
						structs.SetShipping_method(value);
					}
		...
		public void Write(SovOrder structs, Protocol oprot){
			...
			if(structs.GetOpen_user_id() != null) {
				
				oprot.WriteFieldBegin("open_user_id");
				oprot.WriteString(structs.GetOpen_user_id());
				
				oprot.WriteFieldEnd();
			}
			
			
			if(structs.GetVipmoney() != null) {
				
				oprot.WriteFieldBegin("vipmoney");
				oprot.WriteString(structs.GetVipmoney());
			...
			if(structs.GetInvoice_deduct_money() != null) {
				
				oprot.WriteFieldBegin("invoice_deduct_money");
				oprot.WriteString(structs.GetInvoice_deduct_money());
			...
			if(structs.GetPayable_fee() != null) {
				...
				oprot.WriteString(structs.GetPayable_fee());
			...
			if(structs.GetShipping_method() != null) {
				
				oprot.WriteFieldBegin("shipping_method");
				oprot.WriteI32((int)structs.GetShipping_method()); 
