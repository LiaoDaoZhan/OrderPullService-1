					...
					if ("ships".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.marketplace.delivery.ShipInfo elem0;
								
								elem0 = new vipapis.marketplace.delivery.ShipInfo();
								vipapis.marketplace.delivery.ShipInfoHelper.getInstance().Read(elem0, iprot);
