...
namespace vipapis.vsizetable{
	...
	public class VendorSizeTableServiceHelper {
		...
		public class getCategorySizeTableConfigs_args {
			
			///<summary>
			/// 类目ID
			///</summary>
			
			private List<int?> third_category_ids_;
			
			public List<int?> GetThird_category_ids(){
				return this.third_category_ids_;
			}
			
			public void SetThird_category_ids(List<int?> value){
				this.third_category_ids_ = value;
			}
		...
		public class getCategorySizeTableConfigs_result {
			
			///<summary>
			///</summary>
			
			private List<vipapis.vsizetable.CategorySizetableConfig> success_;
			
			public List<vipapis.vsizetable.CategorySizetableConfig> GetSuccess(){
				return this.success_;
			}
			
			public void SetSuccess(List<vipapis.vsizetable.CategorySizetableConfig> value){
				this.success_ = value;
			}
		...
		public class getCategorySizeTableConfigs_argsHelper : TBeanSerializer<getCategorySizeTableConfigs_args>
		{
			
			public static getCategorySizeTableConfigs_argsHelper OBJ = new getCategorySizeTableConfigs_argsHelper();
			
			public static getCategorySizeTableConfigs_argsHelper getInstance() {
				
				return OBJ;
			}
			
			
			public void Read(getCategorySizeTableConfigs_args structs, Protocol iprot){
				...
				if(true){
					...
					structs.SetThird_category_ids(value);
				}
			...
			public void Write(getCategorySizeTableConfigs_args structs, Protocol oprot){
				
				Validate(structs);
				oprot.WriteStructBegin();
				
				if(structs.GetThird_category_ids() != null) {
					
					oprot.WriteFieldBegin("third_category_ids");
					
					oprot.WriteSetBegin();
					foreach(int _item0 in structs.GetThird_category_ids()){
			...
			public void Validate(getCategorySizeTableConfigs_args bean){
		...
		public class getCategorySizeTableConfigs_resultHelper : TBeanSerializer<getCategorySizeTableConfigs_result>
		{
			
			public static getCategorySizeTableConfigs_resultHelper OBJ = new getCategorySizeTableConfigs_resultHelper();
			
			public static getCategorySizeTableConfigs_resultHelper getInstance() {
				
				return OBJ;
			}
			
			
			public void Read(getCategorySizeTableConfigs_result structs, Protocol iprot){
				...
				if(true){
					...
					List<vipapis.vsizetable.CategorySizetableConfig> value;
					
					value = new List<vipapis.vsizetable.CategorySizetableConfig>();
					iprot.ReadListBegin();
					while(true){
						
						try{
							
							vipapis.vsizetable.CategorySizetableConfig elem0;
							
							elem0 = new vipapis.vsizetable.CategorySizetableConfig();
							vipapis.vsizetable.CategorySizetableConfigHelper.getInstance().Read(elem0, iprot);
			...
			public void Write(getCategorySizeTableConfigs_result structs, Protocol oprot){
				...
				if(structs.GetSuccess() != null) {
					...
					oprot.WriteListBegin();
					foreach(vipapis.vsizetable.CategorySizetableConfig _item0 in structs.GetSuccess()){
						
						
						vipapis.vsizetable.CategorySizetableConfigHelper.getInstance().Write(_item0, oprot);
			...
			public void Validate(getCategorySizeTableConfigs_result bean){
		...
		public class VendorSizeTableServiceClient : OspRestStub , VendorSizeTableService  {
			...
			public List<vipapis.vsizetable.CategorySizetableConfig> getCategorySizeTableConfigs(List<int?> third_category_ids_) {
				
				send_getCategorySizeTableConfigs(third_category_ids_);
				return recv_getCategorySizeTableConfigs(); 
				
			}
			
			
			private void send_getCategorySizeTableConfigs(List<int?> third_category_ids_){
				
				InitInvocation("getCategorySizeTableConfigs");
				
				getCategorySizeTableConfigs_args args = new getCategorySizeTableConfigs_args();
				args.SetThird_category_ids(third_category_ids_);
				
				SendBase(args, getCategorySizeTableConfigs_argsHelper.getInstance());
			}
			
			
			private List<vipapis.vsizetable.CategorySizetableConfig> recv_getCategorySizeTableConfigs(){
				
				getCategorySizeTableConfigs_result result = new getCategorySizeTableConfigs_result();
				ReceiveBase(result, getCategorySizeTableConfigs_resultHelper.getInstance());
