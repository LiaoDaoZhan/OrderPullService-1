...
namespace vipapis.vipmax.coupon{
	...
	public class CancelledSkusHelper : TBeanSerializer<CancelledSkus>
	{
		
		public static CancelledSkusHelper OBJ = new CancelledSkusHelper();
		
		public static CancelledSkusHelper getInstance() {
			
			return OBJ;
		}
		
		
		public void Read(CancelledSkus structs, Protocol iprot){
		...
		public void Write(CancelledSkus structs, Protocol oprot){
		...
		public void Validate(CancelledSkus bean){
