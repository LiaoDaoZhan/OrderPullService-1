...
namespace vipapis.vipmax.coupon{
	...
	public class CheckCouponInfoRequestHelper : TBeanSerializer<CheckCouponInfoRequest>
	{
		
		public static CheckCouponInfoRequestHelper OBJ = new CheckCouponInfoRequestHelper();
		...
		public void Read(CheckCouponInfoRequest structs, Protocol iprot){
					...
					if ("order_skus".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.vipmax.coupon.OrderSku elem1;
								
								elem1 = new vipapis.vipmax.coupon.OrderSku();
								vipapis.vipmax.coupon.OrderSkuHelper.getInstance().Read(elem1, iprot);
					...
					if ("coupon_sns".Equals(schemeField.Trim())){
						...
						while(true){
							...
							try{
								...
								vipapis.vipmax.coupon.CouponInfo elem3;
								
								elem3 = new vipapis.vipmax.coupon.CouponInfo();
								vipapis.vipmax.coupon.CouponInfoHelper.getInstance().Read(elem3, iprot);
		...
		public void Write(CheckCouponInfoRequest structs, Protocol oprot){
		...
		public void Validate(CheckCouponInfoRequest bean){
